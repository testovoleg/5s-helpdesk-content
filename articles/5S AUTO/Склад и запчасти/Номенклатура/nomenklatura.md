...
<table><tr><td><b>Время чтения:</b> 20 мин.</td><td><b>Обновлено:</b> 10.06.2026</td></tr></table>
...
- <a id="filtr"></a>Вкладка **"*Фильтр*"** позволяет найти элементы номенклатуры по указанным условиям.
...
На ***вкладке "Признаки"*** расположены предопределенные и добавленные признаки, которые можно назначать для товаров для упрощения работы со справочником "Номенклатура" на этапах подбора запчастей, проценки и оформления документов. Подробнее см. статью *"[Признаки номенклатуры](../Признаки%20номенклатуры/priznaki-nomenklatury.md)"*.
...
**Теги:** Подбор запчастей, номенклатура, тип номенклатуры, вид номенклатуры, характеристики номенклатуры, справочник номенклатуры
