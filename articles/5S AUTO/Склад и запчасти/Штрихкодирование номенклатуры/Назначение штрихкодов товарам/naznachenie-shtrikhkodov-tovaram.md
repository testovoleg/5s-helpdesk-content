...
3. Организовать печать этикеток (см. *[Печать этикеток](../../Печать%20этикеток/pechat-etiketok.md)*), если сканирование товаров планируется производить через сканеры штрихкодов, подключенные через COM-порт.
...
Также есть возможность присваивать штрихкоды товарам в процессе работы с интерфейсом ТСД – см. в *[статье](../../Интерфейс%20для%20ТСД/interfeys-dlya-tsd.md#присвоение-штрихкодов).*
...
Для сканирования товара предварительно должен быть подключен сканер штрихкодов – см. статью *"[Подключение сканера штрихкодов](../../../Торговое%20оборудование/Подключение%20сканера%20штрихкодов/podklyuchenie-skanera-shtrikhkodov.md)"*.
...
**Теги:** Складской учет, штрихкод, назначение штрихкодов, номенклатура, сканирование
