...
Прежде чем создавать задачи по подбору запчастей, необходимо определить пользователей, которые будут эти задачи обрабатывать. Для этого назначьте должность "Специалист по запчастям (CRM)" в регистре сведений "Сведения адресации" (см. *[Адресация задач в CRM по исполнителям](../../Задачи/Адресация%20задач%20в%20CRM%20по%20исполнителям/adresaciya-zadach-v-crm-po-ispolnitelyam.md)*).

Для автоматического создания задачи на подбор запчастей из Заявки на ремонт, необходимо установить [право](../../Пользователи%20и%20права/Установка%20прав%20и%20настроек%20пользователя/ustanovka-prav-i-nastroek-polzovatelya.md) для компании *"Контролировать необходимость запчастей по автоработам"* (группа прав и настроек: ПЯТЬ СИСТЕМ → АВТОСЕРВИС) = "Да".
...
В результате сформируется задача "Подберите запчасти", которая будет видна в АРМ "Рабочий стол" пользователям с должностью "Специалист по запчастям (CRM)" (см. [*Предварительная настройка*](#предварительная-настройка)).
