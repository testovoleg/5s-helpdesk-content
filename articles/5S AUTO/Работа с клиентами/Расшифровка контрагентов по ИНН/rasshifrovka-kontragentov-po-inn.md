...
<table><tr><td><b>Время чтения:</b> 8 мин.</td><td><b>Обновлено:</b> 29.12.2025</td></tr></table>
...
Также предварительно должна быть настроена интеграция с [API 5S AUTO](../../Администрирование%20и%20настройка%20системы/API%205S%20AUTO/api-5s-auto.md) в программе.
...
На вкладке **«Параметры сервиса»** необходимо выбрать интеграцию с [API 5S AUTO](../../Администрирование%20и%20настройка%20системы/API%205S%20AUTO/api-5s-auto.md) и записать настройки:
