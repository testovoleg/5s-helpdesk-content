...
- [Способы перехода в карточку клиента](#способы-перехода-в-карточку-клиента)
...
- [Добавление клиента в базу](#добавление-клиента-в-базу)
  - [1. Из АРМ «Клиенты и автомобили»](#1-из-арм-клиенты-и-автомобили)
  - [2. Из Сделки](#2-из-сделки)
  - [3. Из справочника «Контрагенты и контакты»](#3-из-справочника-контрагенты-и-контакты)
  - [4. Из Заказ-наряда](#4-из-заказ-наряда)
...
Подробнее см. статью «[Чаты клиента](../../Сообщения/Чаты%20клиента/chaty-klienta.md)».

**4. Контакты:**

- **Контактные лица** — данные о контактных лицах данного контрагента (Ф. И. О., вид взаимоотношений, должность и др.). Подробнее см. статью «[Контактные лица](https://www.5systems.ru/help/kontaktnye-lica)».
...
## Способы перехода в карточку клиента
