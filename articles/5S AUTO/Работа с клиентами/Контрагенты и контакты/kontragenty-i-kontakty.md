...
<table><tr><td><b>Время чтения:</b> 20 мин.</td><td><b>Обновлено:</b> 16.09.2026</td></tr></table>
...
- **Согласие на обработку персональных данных** — отметка о согласии на обработку персональных данных. Возможные значения: «Спрашивать» (устанавливается по умолчанию), «Да», «Нет». Если выбрано «Да», на вкладке «Дополнительная информация» напротив реквизита «Согласие дано/отказано» появляется ссылка «Печать», по которой открывается печатная форма согласия для клиента. Печать предусмотрена только для типа клиента «Частное лицо». Подробнее см. совет «[Как распечатать согласие на обработку персональных данных](../../../../tips/5S%20AUTO/CRM/Как%20распечатать%20согласие%20на%20обработку%20персональных%20данных/kak-raspechatat-soglasie-na-obrabotku-personalnyh-dannyh.md)».
- **Согласие на получение SMS** — отметка о согласии на получение SMS.

> *Комментарий: описание значений реквизита «Согласие на обработку персональных данных» и ссылки «Печать» добавлено 16.09.2026 по совету «Как распечатать согласие на обработку персональных данных», на старом сайте его нет. Заметка Кати к гугл-документу совета: телефон клиента в печатную форму согласия не выводится (и по закону не обязателен) — в текст не вынесено.*
...
В АРМ **«[Клиенты и автомобили](../Работа%20в%20АРМ%20Клиенты%20и%20автомобили/rabota-v-arm-klienty-i-avtomobili.md)»** можно найти имеющегося в базе клиента по фамилии или номеру телефона и открыть карточку клиента двойным кликом по нужной строке в списке клиентов:

![Переход в карточку клиента из АРМ «Клиенты и автомобили»](attachments/17-perehod-iz-arm-klienty-i-avtomobili.png)

### 3. Из АРМ «Корзина»

Открыть карточку клиента или перейти в справочник для выбора другого клиента можно из АРМ **«[Корзина](../../Проценка%20запчастей%20и%20работ/Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md)»** нажатием на кнопки **«Выбрать»** или **«Открыть»** в поле **«Клиент»**:

![Переход в карточку клиента из АРМ «Корзина»](attachments/18-perehod-iz-arm-korzina.png)

### 4. Из АРМ «Запись на ремонт»

Из АРМ **«[Запись на ремонт](../../Запись%20на%20ремонт/Календарь%20для%20планирования%20работ/kalendar-dlya-planirovaniya-rabot.md)»** также можно перейти в карточку клиента или открыть справочник «Контрагенты и контакты» нажатием кнопок **«Выбрать»** или **«Открыть»** в поле **«Клиент»**:
