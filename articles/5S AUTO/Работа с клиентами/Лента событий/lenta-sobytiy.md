...
Лента событий может быть открыта нажатием на кнопку **«Лента»** в [карточке клиента](../Контрагенты%20и%20контакты/kontragenty-i-kontakty.md#карточка-контрагента) или нажатием на [диалог или чат](../../CRM/Чаты%20клиента/chaty-klienta.md) в карточке клиента или сделке, а также из других мест программы.
...
*Примечание:* в ленте событий видна история общения только с текущим клиентом. Все сообщения по всем клиентам, отправленные вручную и автоматически, хранятся в регистре «Сообщения» – см. раздел «[Список всех отправленных сообщений](../../Сообщения/Настройка%20автоматической%20отправки%20сообщений%20через%20мессенджеры/nastroyka-avtomaticheskoy-otpravki-soobscheniy-cherez-messendzhery.md#список-всех-отправленных-сообщений)» статьи про автоматическую отправку сообщений.
