...
1. Для разных рекламных каналов задать разные *городские номера:*<br>
   ![Настройка рекламных каналов - Городские номера](attachments/02-nastroyka-reklamnyh-kanalov-gorodskie-nomera.png)
...
2. Задать *код канала:*<br>
   ![Настройка рекламных каналов - Код канала](attachments/03-nastroyka-reklamnyh-kanalov-kod-kanala.png)
   Настройка работает аналогично городским номерам. Рекламный канал определяется по коду.
3. *[Настроить интеграцию с системой аналитики данных](../Настройка%20интеграции%20с%20системой%20аналитики%20Roistat/nastroyka-integracii-s-sistemoy-analitiki-roistat.md)* и задать для рекламного канала *UTM-метки* – параметры перехода на сайт с указанием источника перехода:<br>
   ![Настройка рекламных каналов - UTM-метки](attachments/04-nastroyka-reklamnyh-kanalov-utm-metki.png)
   Настройка производится совместно со специалистами со стороны системы аналитики.
4. Настроить *номера телефонов контрагентов:*<br>
   ![Настройка рекламных каналов - Номера контрагентов](attachments/05-nastroyka-reklamnyh-kanalov-nomera-kontragentov.png)
