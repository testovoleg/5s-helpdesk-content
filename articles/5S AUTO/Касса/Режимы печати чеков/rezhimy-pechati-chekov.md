...
*Примечание:* При выборе режима по умолчанию (расшифровка товаров и услуг) также есть возможность использовать функционал [раздельного пробития чеков](../../Практики/Разделение%20чеков%20ККМ/razdelenie-chekov-kkm.md) для товаров и услуг. В случае использования двух других режимов данный функционал работать не будет.
