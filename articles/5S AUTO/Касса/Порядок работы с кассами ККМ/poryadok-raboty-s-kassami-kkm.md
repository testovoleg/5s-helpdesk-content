...
Как подключить кассу ККМ см. [*Подключение кассы ККМ*](https://5systems.ru/help/podklyuchenie-kassy-kkm). Также см. статью *[Упрощенный Фронт кассира](../Упрощенный%20Фронт%20кассира/uproschennyy-front-kassira.md).*
...
*Описание работы с СБП и необходимых настроек в программе и на стороне банка см. в основной статье "[Работа с СБП](https://5systems.ru/help/rabota-s-sbp)".*
...
Затем перейти на вкладку “Дополнительно” – признак “Показать QR-код” будет активирован, флаг будет установлен по умолчанию. При нажатии кнопки “Пробить чек” открывается окно с QR-кодом, который можно отправить, скопировать, открыть в браузере либо отменить – подробнее см. в [основной статье](https://5systems.ru/help/rabota-s-sbp#dejstv_so_ssylk):
