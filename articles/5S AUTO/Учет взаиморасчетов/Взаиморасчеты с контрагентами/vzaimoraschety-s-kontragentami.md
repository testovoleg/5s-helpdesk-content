...
Договор взаиморасчетов с контрагентом создается программой автоматически при создании Корзины или документа, например, Заказ-наряда, если у контрагента не было договора, либо подтягивает существующий договор. Автосоздание договора регулируется правом *“Автоматическое создание основного договора”* (см. [*Установка прав и настроек*](https://5systems.ru/help/ustanovka-prav-i-nastroek-polzovatelya)*).*
