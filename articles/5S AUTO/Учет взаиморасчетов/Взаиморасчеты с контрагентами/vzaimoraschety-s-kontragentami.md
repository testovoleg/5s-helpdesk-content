...
1. *Флаг “Автоматическое закрытие сделок”* – это признак в договоре взаиморасчетов и в документах движения денежных средств, который задает алгоритм определения, по каким документам следует учесть оплату. Если признак установлен, то при проведении документа оплаты, например, банковской выписки, программа выполняет поиск незакрытых сделок, и относит оплату на эти сделки по ФИФО (сначала самые старые):<br>
