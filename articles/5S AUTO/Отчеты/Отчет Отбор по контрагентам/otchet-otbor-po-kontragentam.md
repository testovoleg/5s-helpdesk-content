...
- На вкладке "Параметры":
  ...
  - Устанавливаем период выполнения работы за прошлый год.<br>
...
- На вкладке "Отбор":
  ...
  - Устанавливаем отбор по полю "Последний заказ наряд.Дата" *Меньше* текущей даты (01.03.2020) на один год.<br>
...
- на вкладке "Параметры" снимаем все отборы:<br>
  ![Снятие отборов с параметров](attachments/06-snyatie-otborov-s-parametrov.png)
- переходим на вкладку "Отбор" и устанавливаем отбор по полю "Автомобиль.Модель автомобиля" *В группе* "BMW":<br>
...
- переходим на вкладку "Отбор" и устанавливаем отбор по полю "Пробег" *Больше* 200 000:<br>
