...
2. [Работа с отчетом](#работа-с-отчетом)
   - 1\. [Формирование отчета](#формирование-отчета)
   - 2\. [Общая логика построения отчета](#общая-логика-построения-отчета)
   - 3\. [Показатели отчета](#показатели-отчета)
   - 4\. [Входящие обращения](#входящие-обращения)
     - [Источники обращений](#источники-обращений)
     - [Отбор по причинам отказа](#отбор-по-причинам-отказа)
   - 5\. [Исходящие обращения](#исходящие-обращения)
...
- *Пропущенный звонок* – показатель попадает в этот раздел, если звонок, на основании которого была создана сделка, был [пропущен](../../Телефония/Работа%20с%20пропущенными%20звонками/rabota-s-propuschennymi-zvonkami.md) (даже если позже по этому звонку перезвонил оператор и записал клиента).
- *Мобильное приложение* – обращение клиента через мобильное приложение [5S LINK](../../Приложение%205S%20LINK/Настройка%20приложения%205S%20LINK%20v2/nastroyka-prilozheniya-5s-link-v2.md).
- *Заявка с сайта* – обращение клиента через сайт (форма обратного звонка на сайте автосервиса).
- *Визит* – когда клиент пришел без звонка (сделка [создана вручную](../../../../lessons/Краткий%20курс%20для%20Автосервиса/Создание%20сделки/sozdanie-sdelki.md)).
- *Чат* – обращение через [мессенджеры](../../Сообщения/).
