...
***Отчет “Регистрация внешних пользователей”*** позволяет получить список клиентов, зарегистрированных в приложении [5S LINK](https://www.5systems.ru/help/nastroyka-prilozheniya-5s-link-v2), с возможностью анализа данных с детализацией по сотрудникам, подразделениям и каналам связи. Отчет позволяет наглядно определить, через кого из сотрудников больше клиентов подключаются к ботам компании в мессенджерах и регистрируются в мобильном приложении.
...
- [Настройка приложения 5S LINK v2](https://www.5systems.ru/help/nastroyka-prilozheniya-5s-link-v2);
- [Мобильное приложение 5S LINK v1](https://www.5systems.ru/help/mobilnoe-prilozhenie-5s-link-v1);
- [Внешние пользователи](https://www.5systems.ru/help/vneshnie-polzovateli).
...
В отчет попадают данные о регистрации как в классическом приложении [5S LINK v1](https://www.5systems.ru/help/mobilnoe-prilozhenie-5s-link-v1), так и в веб-приложении [5S LINK v2](https://www.5systems.ru/help/nastroyka-prilozheniya-5s-link-v2).
...
1. *Внешний пользователь* – пользователь мобильного приложения, в значение подтягивается ФИО из карточки справочника “[Внешние пользователи](https://www.5systems.ru/help/vneshnie-polzovateli)”, которая создается в момент регистрации клиента в приложении 5S LINK.
