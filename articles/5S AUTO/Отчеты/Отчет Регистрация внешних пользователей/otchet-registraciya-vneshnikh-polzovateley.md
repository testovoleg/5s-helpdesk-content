...
2. Выбрать *вариант группировки строк* – по мастеру Заказ-наряда или по менеджеру (ответственному) в Сделке.<br><br>
   ...
   Для выбора варианта группировки следует открыть форму поля группировки строк *“Мастер (Заказ-наряд), Менеджер”.* По умолчанию установлены обе галочки – нужно снять лишнюю и нажать кнопку “ОК”:<br>
   ![Отчет Регистрация внешних пользователей - Настройки](attachments/02-otchet-registraciya-vneshnih-polzovateley-nastroyki.png)
3. Нажать кнопку *“Сформировать”:*<br>
