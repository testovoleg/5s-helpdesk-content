...
Также отчет «Операционная воронка продаж» используется для работы с *[системой аналитики Roistat](https://5systems.ru/help/nastroyka-integracii-s-sistemoy-analitiki-roistat)*.
