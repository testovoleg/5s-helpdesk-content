...
- колонка "Подобрал з/ч" табличной части "Товары" Заказ-наряда в состоянии "Закрыт" (см. [*Учет выработки специалистов по запчастям в Заказ-нарядах*](https://5systems.ru/help/uchet-vyrabotki-specialistov-po-zapchastyam-v-zakaz-naryadakh)).
