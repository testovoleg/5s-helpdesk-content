...
**Обратите внимание!** Номенклатура создается в группе, указанной в параметре «Группа для новой номенклатуры» [Настроек Помощника автосервиса](../../Администрирование%20и%20настройка%20системы/Настройки%20Помощника%20автосервиса/nastroyki-pomoschnika-avtoservisa.md).
