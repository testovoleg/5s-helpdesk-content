...
- [Занесение результатов диагностической анкеты в Заказ-наряде](#занесение-результатов-диагностической-анкеты-в-заказ-наряде)
  - [Командное меню обработки диагностической анкеты](#командное-меню-обработки-диагностической-анкеты)
...
Если в ходе проверки по диагностической анкете найдены проблемы и предупреждения, перейдите из Заказ-наряда в АРМ **«[Корзина](../Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md)»** с целью формирования предложений по ремонту для автомобиля клиента.

Для формирования предложения по выявленным проблемам и замечаниям через АРМ «Корзина» для начала нужно ознакомиться с принципами работы в [АРМ «Корзина»](../Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md) и с [Применяемостью](https://www.5systems.ru/help/rabota-s-primenyaemostyu).
...
- **Работы и детали, связанные с пунктом проверки** — отображаются все созданные связи при работе с применяемостью, позволяет создать связи (см. [Работа с применяемостью](https://www.5systems.ru/help/rabota-s-primenyaemostyu)).
...
4. Если среди связей есть подходящие работы/детали/номенклатура, то добавьте выбранную работу/деталь/номенклатуру в Корзину или в Варианты поставки (см. [Работа с применяемостью → Использование применяемости для подбора](https://www.5systems.ru/help/rabota-s-primenyaemostyu)).
...
Полный список действий с товарами/работами в Корзине см. [Работа в АРМ Корзина → 5. Панель действий](../Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md#5-панель-действий).
