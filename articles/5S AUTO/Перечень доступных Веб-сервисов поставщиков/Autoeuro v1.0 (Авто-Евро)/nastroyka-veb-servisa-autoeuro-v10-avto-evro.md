...
3. Обновление словарей сервиса нажатием кнопки-ссылки «Обновить словари для заказов»:<br>
...
- *Ключ API* – Ключ доступа покупателя. API ключ, указан в карточке клиента [https://api.autoeuro.ru/client/prefereces](https://api.autoeuro.ru/client/prefereces)<br>
