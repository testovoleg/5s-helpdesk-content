...
2. Обновить словари сервиса путем нажатия кнопки-ссылки *"Обновить словари заказов":*<br>
...
- *ключ доступа –* API-ключ доступа покупателя, полученный у менеджера "РОЛЬФ":<br>
