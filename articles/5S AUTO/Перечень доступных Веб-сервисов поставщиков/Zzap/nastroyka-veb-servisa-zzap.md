...
2. Получить api_key:<br>
   2.1. Если вы покупатель, напишите на почту [support@zzap.pro](mailto:support@zzap.pro) или создайте заявку в разделе "Заявки на тех.поддержку", и вам пришлют api_key.<br>
   2.2. Если вы продавец и знаете, кто ваш менеджер, обратитесь к нему - менеджер вышлет вам api_key.<br>
   2.3. Если вы продавец, но по каким-то причинам не знаете, кто ваш менеджер, или на данный момент к вам не прикреплён ни один из менеджеров, поступайте, как покупатель.
