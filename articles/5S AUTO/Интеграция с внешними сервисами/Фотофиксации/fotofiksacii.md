...
2. [Настройка интеграции](#настройка-интеграции)
   ...
   - [Настройка события по обнаружению автомобильного номера в Revisor](#настройка-события-по-обнаружению-автомобильного-номера-в-revisor)
...
3. Перейдите к редактированию действия, где:<br>
   3.1. Выберите вариант действия "Отправить сообщение" или "Шаблон сообщения".<br>
   3.2. На вкладке "Параметры сообщения" выберите существующий или создайте и выберите новый шаблон сообщения (как настроить шаблон см. [*Шаблоны сообщений*](../../Сообщения/Шаблоны%20сообщений/shablony-soobscheniy.md)*):*<br><br>
