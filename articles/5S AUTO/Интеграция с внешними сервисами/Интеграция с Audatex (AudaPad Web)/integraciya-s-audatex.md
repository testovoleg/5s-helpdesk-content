...
Компания **«[Аудатэкс](https://www.audatex.ru)»** — мировой лидер в области разработки программного обеспечения для расчета стоимости восстановительного ремонта транспортного средства.
...
Дополнение не является самостоятельной программой и используется только в составе конфигураций «Альфа-Авто, редакция 5». Модуль входит в типовой продукт, но для его активации требуется специальная лицензия на дополнение и обновление ключа защиты.

Для подключения интеграции обратитесь на портал технической поддержки 5SYSTEMS. Стоимость см. в разделе [Каталог услуг → Онлайн-сервисы](https://www.5systems.ru/services/integraciya-s-audatex) (уточняйте актуальную стоимость у специалистов 5SYSTEMS).

> *Комментарий: стоимость — 1/2 от цены на [сайте Раруса](https://rarus.ru/1c-auto/dopolneniya-alfa-avto/).*
