...
<sub>Источник: https://www.5systems.ru/help/nastroyka-integracii-s-katalogami-laximo</sub>
...
Для настройки подключения к сервисам Laximo перейдите в [*настройки Помощника автосервиса*](../../Администрирование%20и%20настройка%20системы/Настройки%20Помощника%20автосервиса/nastroyki-pomoschnika-avtoservisa.md).
...
1. ![Просмотр параметров доступа Laximo 1](attachments/01-prosmotr-parametrov-dostupa-laximo-1.png)
2. ![Просмотр параметров доступа Laximo 2](attachments/02-prosmotr-parametrov-dostupa-laximo-2.png)
3. ![Просмотр параметров доступа Laximo 3](attachments/03-prosmotr-parametrov-dostupa-laximo-3.png)

Заполните параметры "Логин", "Код доступа" настроек Помощника автосервиса:

![Настройки подключения Laximo](attachments/04-nastroyki-podklyucheniya-laximo.png)
