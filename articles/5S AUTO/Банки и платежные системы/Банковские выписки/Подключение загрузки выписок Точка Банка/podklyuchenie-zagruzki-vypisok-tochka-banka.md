...
В карточке ключа в разделе *“JWT-ключи”* отображаются *Токен* и *Client_ID:*
...
- **Токен** – JWT-токен из карточки ключа (либо по ссылке *“Скопировать ключ”* сразу после создания);
- **Client_ID** – идентификатор приложения из карточки ключа;
