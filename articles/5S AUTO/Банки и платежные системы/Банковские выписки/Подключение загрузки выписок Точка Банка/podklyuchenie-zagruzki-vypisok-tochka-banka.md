...
> *Комментарий: черновик. Скриншотов нет — нужны скрины формы «Добавление новой записи списка» обработчика «Точка Банк API Загрузка выписок» и меню «Методы интеграции»; состав полей формы и релиз, с которого доступен обработчик, — уточнить у разработчика.*
...
Добавить новую запись списка и заполнить параметры:
