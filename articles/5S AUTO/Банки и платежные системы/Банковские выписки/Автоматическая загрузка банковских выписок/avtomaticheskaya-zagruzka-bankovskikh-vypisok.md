...
<table><tr><td><b>Время чтения:</b> 12 мин.</td><td><b>Обновлено:</b> 18.09.2026</td></tr></table>
...
- Т-Банк (Tinkoff);
- Альфа-Банк;
- Точка Банк (начиная с релиза 2.8.5).
...
- [Подключение API Точка Банка](../Подключение%20загрузки%20выписок%20Точка%20Банка/podklyuchenie-zagruzki-vypisok-tochka-banka.md).

## Настройка в программе

### 1. Проверка интеграции с API 5S AUTO

Предварительно должна быть настроена интеграции с [API 5S AUTO](../../../Администрирование%20и%20настройка%20системы/API%205S%20AUTO/api-5s-auto.md). Если это не будет выполнено, то функционал автоматической загрузки работать не будет.
