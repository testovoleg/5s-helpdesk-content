...
2. *Загрузить в существующую*<br>
   При выборе этого режима данные загружаются в существующую банковскую выписку: ее необходимо выбрать нажатием на соответствующую кнопку  ![Кнопка Выбрать](attachments/08-knopka-vybrat.png). Либо можно изначально вызвать обработку из этой выписки, тогда она автоматически подгрузится в поле “Загрузить в существующую”:<br>
