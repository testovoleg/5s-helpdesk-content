...
3. Блок "Решение руководителя"<br>
   **1.** *Руководитель* - сотрудник, являющийся руководителем.<br>
   **2.** *Решение* - состоит из:<br>
   **1)** выбора варианта решения: решение может быть не принято или принято — снизить премию на сумму / провести обучение;<br>
   **2)** описания решения.
