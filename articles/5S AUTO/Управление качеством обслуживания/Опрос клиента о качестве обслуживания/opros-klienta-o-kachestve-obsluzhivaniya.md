...
<table><tr><td><b>Время чтения:</b> 17 мин.</td><td><b>Обновлено:</b> 21.09.2023</td></tr></table>
...
1. Перейдите в справочник "Типовые анкеты":<br>
   ![Опрос по качеству - Типовые анкеты](attachments/01-opros-po-kachestvu-tipovye-ankety.png)
2. Создайте анкету с вопросами для оценки качества обслуживания:<br>
...
3. В настройке "УПРАВЛЕНИЕ КАЧЕСТВОМ → Анкета для опроса по качеству" укажите анкету, которую создали (см. [*1. Создание анкеты*](#1-создание-анкеты)):<br>
...
1. Перейти в справочник "Автоматические действия" и найти регламентное задание "Создание документов "Опрос" по заказ-нарядам":<br>
   ![Опрос по качеству - Автоматические действия](attachments/04-opros-po-kachestvu-avtomaticheskie-deystviya.png)
2. Открыть форму регламентного задания, установить флажок "Использовать" и нажать на кнопку "ОК":<br>
