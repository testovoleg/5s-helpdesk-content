...
В таблице отмечаются реквизиты, обязательные для заполнения в бизнес-процессах, – например, «Контактный телефон». Если отмеченный реквизит не заполнен, бизнес-процесс не записывается.
