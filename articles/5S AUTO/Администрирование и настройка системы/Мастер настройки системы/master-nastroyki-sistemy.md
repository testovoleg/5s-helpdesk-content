...
- **Контролировать соответствие обращений по реквизитам** – *описание в разработке*.

> *Комментарий: уточнить назначение настройки «Контролировать соответствие обращений по реквизитам» (реквизиты «Контрагент», «Автомобиль», «ПодразделениеКомпании»).*
