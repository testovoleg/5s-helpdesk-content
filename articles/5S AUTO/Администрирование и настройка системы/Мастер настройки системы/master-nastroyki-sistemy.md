...
- **Глубина поиска сделок в работе, дн.** – если у клиента есть открытая сделка в пределах этого периода, обращение попадает в нее; если открытая сделка старше – создается новая.
- **Глубина поиска отказных сделок, дн.** – если клиент снова обратился в пределах этого периода от даты закрытия сделки, отказная сделка снова становится рабочей. По умолчанию – 2 дня.
...
Остальные параметры группы *(описание в разработке)*:

- Создавать сделку при записи корзины;
- Глубина поиска заказ-нарядов и заказов покупателей, дн.;
- Период выдачи документов для мобильного приложения, дн.;
- Контролировать соответствие обращений по реквизитам.
