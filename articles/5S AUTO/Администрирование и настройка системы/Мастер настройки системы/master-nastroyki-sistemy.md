...
- **Контролировать соответствие обращений по реквизитам** – реквизиты, по которым программа определяет, что новая сделка дублирует уже открытую: «Контрагент», «Автомобиль», «ПодразделениеКомпании». Сделка считается дублирующей, если совпадают все отмеченные реквизиты. Подробнее – в статье «[Объединение сделок → Описание](../../CRM/Объединение%20сделок/obedinenie-sdelok.md#описание)».
