...
- если у пользователя в данном праве будет установлено значение “Нет”, то при попытке редактирования документа в закрытом периоде формы документов будут открываться для него в режиме просмотра, и будет выходить предупреждение программы:<br>
