...
4. Загрузить с компьютера файл с печатной формой нажатием на кнопку “Загрузить”  ![Внешние печатные формы - Кнопка Загрузить](attachments/02-vneshnie-pechatnye-formy-knopka-zagruzit.png).<br>
   *Пример файла для загрузки можно скачать по ссылке:* [Печать корзины.7z](attachments/pechat-korziny.7z) (требуется разархивировать).<br>
...
Загруженная форма будет вызываться на печать по кнопке [“Печать корзины”](../../../../../lessons/Урок%206.%20Подбор%20запчастей%20и%20работ/Как%20распечатать%20Корзину%20или%20отправить%20в%20мессенджер/kak-raspechatat-korzinu-ili-otpravit-v-messendzher.md) вместо стандартной формы печати Корзины.

## Файл для скачивания

- [Печать корзины](attachments/pechat-korziny.7z) (.7z, 11 КБ)
