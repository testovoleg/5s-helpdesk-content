...
1. Перейдите в установку [настроек и прав](https://www.5systems.ru/help/ustanovka-prav-i-nastroek-polzovatelya), выберите тип объекта "Организация", в качестве объекта выберите организацию, для которой будет установлен запрет редактирования документов.
...
Если организаций несколько, то выполните запрет для остальных организаций таким же способом, изменив значение в поле "Объект", либо через [групповую установку прав](https://www.5systems.ru/help/ustanovka-prav-i-nastroek-polzovatelya#grupust):
