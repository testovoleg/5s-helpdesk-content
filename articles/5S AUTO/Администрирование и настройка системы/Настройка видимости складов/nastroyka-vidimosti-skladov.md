...
> *Функционал доступен начиная с релиза 2.8.2. Разделение настройки видимости остатков и права проведения документов – с релиза 2.8.3.*
...
Для пользователей *без ограничений доступа по подразделениям* (с [ролями](https://www.5systems.ru/help/roli-polzovateley) “Пользователь”, “Минимальный набор прав” или “Полные права”) настройка видимости складов позволяет *запретить проведение документов* по каждому отдельному складу.
...
Доступ к складам настраивается в карточке [пользователя](https://www.5systems.ru/help/polzovateli) программы на вкладке *“Доступ к складам”:*
