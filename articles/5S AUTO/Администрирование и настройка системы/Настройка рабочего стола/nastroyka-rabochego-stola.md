...
В справочнике “[*Пользователи*](https://5systems.ru/help/polzovateli)” есть связка пользователя с настройкой “Рабочий стол”, т.е. тот вариант настройки рабочего стола, который будет открываться ему при входе в систему.
...
Чтобы активировать функцию, необходимо в [*Правах и настройках системы*](https://5systems.ru/help/ustanovka-prav-i-nastroek-polzovatelya) для права *“Автоматическая блокировка пользователя”* задать значение в минутах – это время простоя, по истечении которого работа в программе будет блокироваться – и записать изменения:
...
Дальнейшие действия аналогичны, как при ручной блокировке (см. [статью](https://5systems.ru/help/struktura-interfeysa-5s-auto#razblock)).
