...
- [Введение](#введение)
- [Добавление пользователей администратором](#добавление-пользователей-администратором)
...
- [Самостоятельная регистрация пользователем](#самостоятельная-регистрация-пользователем)
...
- [3. Регистрация пользователя для контрагента](#3-регистрация-пользователя-для-контрагента)
...
Существует возможность *управлять списком учетных записей* напрямую из справочников [пользователей](https://www.5systems.ru/help/polzovateli) и [контрагентов](../../Работа%20с%20клиентами/Контрагенты%20и%20контакты/kontragenty-i-kontakty.md) 5S AUTO.
...
Добавить нового пользователя 5S Cloud может [пользователь](https://www.5systems.ru/help/polzovateli) программы 5S AUTO с правами *администратора.*
...
***Внимание!*** ***Введенный пароль будет использоваться во всех сервисах компании 5SYSTEMS, доступ к которым осуществляется через авторизацию в 5S Cloud. Обязательно* <u>*сохраните пароль*</u> *в безопасном месте, чтобы не забыть.***
...
Пользователь 5S Cloud автоматически блокируется при установке признака “Сотрудник уволен” в карточке пользователя 5S AUTO на [вкладке “Сотрудник”](https://www.5systems.ru/help/polzovateli#vkl_sotr) или признака “Уволен” в карточке сотрудника.
...
## 3. Регистрация пользователя для контрагента
