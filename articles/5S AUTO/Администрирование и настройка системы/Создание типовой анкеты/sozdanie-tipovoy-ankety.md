...
1. Перейдите на вкладку "Макет печатной формы" формы редактирования анкеты и нажмите кнопку "Заполнить":<br>
   ![Типовые анкеты - Печатная форма](attachments/10-tipovye-ankety-pechatnaya-forma.png)
2. Подкорректируйте макет (например, уберите код раздела) и запишите изменения:<br>
