...
На форме создания вопроса заполним наименование, выберем вид ответа на вопрос "да/нет" (см. ниже *"Виды ответов"*) и нажмем кнопку "ОК":
...
Вторым вопросом раздела создадим вопрос с видом ответа "несколько вариантов из списка" (см. далее *"Виды ответов"*) и заполним возможные варианты ответов:
...
Все возможные параметры обязательности заполнения см. *"Параметры обязательности для вопроса"*.

И создадим второй раздел "Рекомендации". В раздел добавим необязательный для заполнения вопрос с видом ответа "одного из вариантов" (см. *"Виды ответов"*):
