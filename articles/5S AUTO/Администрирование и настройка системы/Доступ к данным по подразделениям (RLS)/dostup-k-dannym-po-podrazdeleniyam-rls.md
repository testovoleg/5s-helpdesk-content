...
Для пользователя RLS обязательно должен быть настроен доступ к подразделению, принадлежность к которому указана на вкладке “[Параметры пользователя](https://5systems.ru/help/polzovateli#parametry_polz)”. Дополнительно может быть добавлен доступ к другим подразделениям.
...
*Примечание:* Необходимо в [Правах и настройках](https://5systems.ru/help/ustanovka-prav-i-nastroek-polzovatelya) запретить доступ к данному справочнику сотруднику, для которого будет назначаться роль “Пользователь RLS”, иначе он будет иметь возможность самостоятельно настроить для себя доступ к любым подразделениям.
