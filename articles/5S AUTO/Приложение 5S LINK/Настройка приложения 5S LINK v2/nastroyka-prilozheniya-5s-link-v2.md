...
Для перехода к странице управления приложением необходимо открыть 5S LINK в браузере и в адресной строке дописать окончание */admin.* В итоге адрес должен иметь следующий вид: *https://your_company.link.5systems.ru/<u>admin</u>.*
