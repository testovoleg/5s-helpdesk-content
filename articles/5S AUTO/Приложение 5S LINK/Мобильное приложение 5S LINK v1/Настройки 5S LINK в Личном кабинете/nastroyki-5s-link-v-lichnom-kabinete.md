...
- Телефоны в мессенджерах и ссылки на соцсети – появятся в контактах в виде кнопок:<br>
  ![МП - ЛК Техцентры низ](attachments/08-mp-lk-tehcentry-niz.png)
  Пример отображения в приложении:<br>
