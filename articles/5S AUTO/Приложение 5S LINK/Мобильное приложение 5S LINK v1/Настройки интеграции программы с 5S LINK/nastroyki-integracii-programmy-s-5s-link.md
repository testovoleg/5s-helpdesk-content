...
7. *Ценообразование:*
   - Тип цены: можно назначить минимальную цену – тогда для услуги будет указана цена “от …”.<br>
     ![МП - Ценообразование](attachments/06-mp-cenoobrazovanie.png)
     Если выбран вариант “Без цены”, то цена услуги указана не будет:<br>
     ![МП - Описание работы Без описания ](attachments/07-mp-opisanie-raboty-bez-opisaniya.png)
   ...
   - Тип скидки – можно задать сумму или процент скидки. Если выбран тип “Минимальная цена”, то в приложении будет отображаться сразу сумма с учетом скидки. Если выбрать цену “Из автоработы”, то стоимость в описании услуги будет отображаться следующим образом:<br>
     ![МП - Скидки](attachments/08-mp-skidki.png)
