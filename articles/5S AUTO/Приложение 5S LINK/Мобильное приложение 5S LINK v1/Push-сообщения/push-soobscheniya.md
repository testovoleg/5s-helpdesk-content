...
Чтобы отправить сообщение через Мобильное приложение из [Сделки](../../../CRM/Работа%20со%20сделкой/rabota-so-sdelkoy.md), следует перейти на вкладку “Сообщение” в *[событиях сделки](../../../CRM/События%20сделки/sobytiya-sdelki.md),* выбрать канал связи *“Мобильное приложение”,* написать сообщение, при необходимости загрузить файл и нажать кнопку “Отправить”:
