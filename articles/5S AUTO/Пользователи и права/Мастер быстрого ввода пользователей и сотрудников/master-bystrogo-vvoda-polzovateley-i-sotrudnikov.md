...
***Внутренний телефон*** заполняется только в том случае, если данный сотрудник (либо он и его сменщик) всегда работает с этим номером. Если трубки между сотрудниками постоянно передаются – внутренний номер указывать не нужно. Подробнее см. [*статью*](https://5systems.ru/help/nastroyka-vnutrennikh-telefonov-sotrudnikov).
