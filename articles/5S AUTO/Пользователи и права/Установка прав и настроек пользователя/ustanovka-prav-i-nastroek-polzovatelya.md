...
<table><tr><td><b>Время чтения:</b> 18 мин.</td><td><b>Обновлено:</b> 27.06.2025</td></tr></table>
...
Чтобы поменять значение «Объект», можно нажать «Выбрать из списка» Выбор  ![Кнопка Выбор Стрелка](attachments/11-knopka-vybor-strelka.png), или, если там нет нужного варианта и нужен другой пользователь – нажать «Выбрать» ![Кнопка Выбрать](attachments/12-knopka-vybrat.png) и выбрать нужный шаблон прав. Дальнейшая настройка идет на выбранный шаблон.
...
Если неизвестно, в каком разделе искать, можно *развернуть* Дерево и найти право через *«поиск»* на верхней стандартной панели. В строку поиска нужно ввести название права или часть его названия. Далее нажать Enter либо воспользоваться кнопками ![Кнопки поиска](attachments/15-knopki-poiska.png) рядом со строкой поиска. Программа находит последовательно права, содержащие в названии введенное слово или часть слова.
