...
1. В основном праве должно быть  установлено значение “Нет”, т.е. сотрудник не может редактировать проведенные документы и проводить документы задним числом:<br>
   ![Права и настройки - Расширение прав доступа](attachments/23-prava-i-nastroyki-rasshirenie-prav-dostupa.png)
2. Затем следует перейти на вкладку “Расширение прав доступа”, добавить документ “Заявка на ремонт”, установить значение "Да" и Записать:<br>
