...
- **Позвонить клиенту**;
- **Лента событий** — откроется окно [Ленты событий](https://www.5systems.ru/help/lenta-sobytiy), где отображаются не только сообщения чата, но и прочая переписка с клиентом и звонки;
...
Интерфейса работы с внутренними чатами в программе больше нигде нет. Интерфейс переписки с клиентами есть в [Ленте событий](https://www.5systems.ru/help/lenta-sobytiy).
