...
Адресация как всех задач на АРМ, так и сообщений происходит через [регистр сведений «Сведения адресации»](../../Задачи/Адресация%20задач%20в%20CRM%20по%20исполнителям/adresaciya-zadach-v-crm-po-ispolnitelyam.md) — один из основных регистров управления всей CRM. В нем прописаны связи между пользователями, должностями CRM и подразделениями.
