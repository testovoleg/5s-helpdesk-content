...
**3. «Клиенты и автомобили».** Переход в [АРМ «Клиенты и автомобили»](https://www.5systems.ru/help/rabota-v-arm-klienty-i-avtomobili).

**4. «Корзина».** Переход в [АРМ «Корзина»](https://www.5systems.ru/help/rabota-v-arm-korzina).
...
Можно вести поиск в выбранном разделе — Контрагенты, Автомобили, Сделки, Заказ-наряды, Реализации, Заказы, Меню — либо искать во всех разделах одновременно. О работе с поиском см. подробнее в статье «[Работа с полнотекстовым поиском](https://www.5systems.ru/help/rabota-s-polnotekstovym-poiskom)».
