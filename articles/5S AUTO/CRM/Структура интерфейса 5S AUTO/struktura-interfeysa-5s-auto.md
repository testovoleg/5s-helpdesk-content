...
**10. «Управление персоналом».** В разделе собраны инструменты для учета рабочего времени сотрудников и выработки, управления качеством, а также для реализации [системы мотивации](../../Персонал%20и%20мотивация/Описание%20возможностей%20системы%20мотивации/opisanie-vozmozhnostey-sistemy-motivacii.md).
...
Чтобы поиск работал, необходимо включить регламентное задание — см. статью «[Настройка полнотекстового поиска](../../Администрирование%20и%20настройка%20системы/Настройка%20полнотекстового%20поиска/nastroyka-polnotekstovogo-poiska.md)».
...
**Автоматическая блокировка.** Есть возможность настроить автоматическую блокировку программы по истечении нескольких минут бездействия пользователя — см. статью «[Настройка рабочего стола → Автоматическая блокировка работы в программе](../../Администрирование%20и%20настройка%20системы/Настройка%20рабочего%20стола/nastroyka-rabochego-stola.md#автоматическая-блокировка-работы-в-программе)».
