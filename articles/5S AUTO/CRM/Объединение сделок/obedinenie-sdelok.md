...
Программа определяет новую сделку как дублирующую, если есть незакрытая сделка с такими же данными. Какие реквизиты при этом сравниваются – клиент, автомобиль, подразделение, – задается в Мастере настройки системы параметром «Контролировать соответствие обращений по реквизитам» – см. «[Мастер настройки системы → Поиск сделок и документов](../../Администрирование%20и%20настройка%20системы/Мастер%20настройки%20системы/master-nastroyki-sistemy.md#поиск-сделок-и-документов)».

Данные клиента и автомобиля в лидах и сделках сравниваются по следующему принципу:
