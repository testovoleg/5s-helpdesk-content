...
Количество непрочитанных уведомлений отображается индикатором на кнопке с колокольчиком на верхней панели [интерфейса](https://www.5systems.ru/help/struktura-interfeysa-5s-auto):
...
В зависимости от [настроек, заданных в карточке конкретного уведомления](https://www.5systems.ru/help/nastroyka-parametrov-uvedomleniy): если пользователь не закрыл push-окно, то оно скроется и может остаться незамеченным, либо оно будет повторно появляться и исчезать, пока его не закроют.
...
| Удаление сделки | Создается, если сделка помечается [удаленной](https://www.5systems.ru/help/redaktirovanie-i-udalenie-sdelok) | Адресуется всем сотрудникам, кому назначена должность «Руководитель техцентра» в регистре «[Сведения адресации](https://www.5systems.ru/help/adresaciya-zadach-v-crm-po-ispolnitelyam)» |
...
| Создана сделка без ответственного | Возникает при создании сделки без ответственного | Адресуется всем пользователям, кому назначены роли, указанные в [настройках воронки продаж на вкладке «Адресация уведомлений»](https://www.5systems.ru/help/nastroyki-voronki-prodazh#adr_uved) |
...
Настройка параметров уведомлений, в том числе логики их работы, производится в карточке каждого уведомления. Подробнее см. в статье «[Настройка параметров уведомлений](https://www.5systems.ru/help/nastroyka-parametrov-uvedomleniy)».
