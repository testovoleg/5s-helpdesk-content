...
Сделки могут быть представлены на рабочем столе в одном из двух режимов: список либо канбан. О работе со списком сделок см. статью «[Список сделок](https://www.5systems.ru/help/spisok-sdelok)».
...
Более детальный отбор доступен при работе со сделками в режиме списка — см. в статье «[Список сделок → Комплексная настройка отборов](https://www.5systems.ru/help/spisok-sdelok#nastrotborov)».

Также отбор можно сохранить для последующего быстрого выбора через меню: подробнее см. в статье «[Сохранение настроек просмотра сделок](https://www.5systems.ru/help/sokhranenie-nastroek-prosmotra-sdelok)».
