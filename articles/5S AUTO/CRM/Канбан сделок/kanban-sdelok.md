...
<table><tr><td><b>Время чтения:</b> 11 мин.</td><td><b>Обновлено:</b> 07.08.2026</td></tr></table>
...
При каждом новом обращении — входящее письмо, звонок, сообщение в чате — автоматически создается [сделка](../Работа%20со%20сделкой/rabota-so-sdelkoy.md). Также сделку можно добавить вручную с помощью кнопки **«Добавить сделку»**.
...
Можно использовать преднастроенный набор стадий, изменить их, а также добавить новые стадии при необходимости. Подробнее см. в статье «[Настройки воронки продаж](../Настройки%20воронки%20продаж/nastroyki-voronki-prodazh.md)».
...
Вид карточки можно настраивать — см. описание в статье «[Настройки воронки продаж → Настройка карточки](../Настройки%20воронки%20продаж/nastroyki-voronki-prodazh.md#2-настройка-карточки)».
...
Нажатием на кнопку открывается «[Лента событий](../../Работа%20с%20клиентами/Лента%20событий/lenta-sobytiy.md)», где можно прочитать сообщение клиента и написать ответ.
