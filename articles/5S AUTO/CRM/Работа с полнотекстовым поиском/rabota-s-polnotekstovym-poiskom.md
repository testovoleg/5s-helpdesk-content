...
В результате найден заказчик с введенной фамилией «Смирнова» в заказ-наряде. Двойным кликом на строку с нужным результатом поиска открывается соответствующий документ, сделка или элемент справочника — в рассматриваемом примере заказ-наряд.
