...
<table><tr><td><b>Время чтения:</b> 14 мин.</td><td><b>Обновлено:</b> 12.03.2024</td></tr></table>
...
- **При звонке** — автозавершение задач при звонке настраивается для [работы с пропущенными звонками](../../Телефония/Работа%20с%20пропущенными%20звонками/rabota-s-propuschennymi-zvonkami.md): чтобы после созвона с клиентом задачи не висели на канбане и другой пользователь повторно не побеспокоил клиента.
