...
- заголовок сделки — стандартный заголовок можно изменить, см. статью «[Заголовок сделки](https://www.5systems.ru/help/zagolovok-sdelki)»;
- статус клиента;
- рекламный канал;
- сумма;
...
В правой половине формы сделки отображаются все события по данной сделке: задачи, звонки, комментарии, изменения этапов сделки и др. Подробнее см. в статье «[События сделки](https://www.5systems.ru/help/sobytiya-sdelki)».
