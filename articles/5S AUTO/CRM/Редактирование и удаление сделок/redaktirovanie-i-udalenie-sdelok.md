...
Возможность помечать сделки на удаление ограничивается [правом](../../Пользователи%20и%20права/Установка%20прав%20и%20настроек%20пользователя/ustanovka-prav-i-nastroek-polzovatelya.md) **«Разрешить удалять сделки»**:

![Право «Разрешить удалять сделки»](attachments/06-pravo-udalyat-sdelki.png)

Окончательное удаление сделок, помеченных на удаление, доступно пользователям с [ролью](../../Пользователи%20и%20права/Пользователи/polzovateli.md#dostupnye_roli) администратора с полными правами.
