...
<table><tr><td><b>Время чтения:</b> 8 мин.</td><td><b>Обновлено:</b> 21.06.2022</td></tr></table>
...
1. Добавлен справочник "Классы автомобилей";
2. Добавлен реквизит "Класс а/м" в справочник "Модели автомобилей";
3. Добавлена возможность выбора установки цены на модель или класс автомобиля в документе "Изменение цен авторабот";

Для определения стоимости работы или стоимости нормочаса работы действует следующий приоритет:

1. Установлена цена на конкретную модель автомобиля.
2. Установлена цена на класс автомобиля.
3. Установлена цена на группу моделей.
4. Установлена цена на любой автомобиль (не заполнен параметр "Модель/класс").
