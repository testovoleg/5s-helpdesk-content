...
Основным поставщиком ТС ПИоТ является разработчик «Единая сервисная платформа», решение называется [«Единый сервисный модуль» («ЕСМ»)](https://ao-esp.ru/#ESM). Подробные инструкции о подключении ЕСМ см. на сайте АО «ЕСП»: [База знаний АО «ЕСП»](https://ao-esp.ru/base).

Схема кассового узла с подключенным ЕСМ (источник изображения — [сайт ЕСП](https://ao-esp.ru/#ESM)):

![Схема кассового узла с подключенным ЕСМ](attachments/01-shema-kassovogo-uzla.png)

Установка ЕСМ — первый шаг настройки ТС ПИоТ. Общий порядок настройки и назначение компонентов описаны в статье [«Настройка интеграции с ТС ПИоТ»](../Настройка%20интеграции%20с%20ТС%20ПИоТ/nastroyka-integracii-s-ts-piot.md).

## Шаг 1. Регистрация и оплата

Первым делом необходимо зарегистрироваться на площадке [АО ЕСП](https://ao-esp.ru) — для этого следует перейти на сайт [https://ao-esp.ru](https://ao-esp.ru), нажать кнопку «Стать клиентом» и пройти регистрацию для своей организации (см. [инструкцию](https://ao-esp.ru/base/install-update/registration)).
...
Далее требуется выбрать и оплатить [пакет обслуживания](https://ao-esp.ru/#Price) — по счету или СБП. После регистрации доступен тестовый период на 7 дней, который позволяет сразу скачивать и настраивать ПО.
...
После установки ЕСМ следует перейти к установке [Локального модуля Честного знака](../Установка%20Локального%20модуля%20Честного%20знака/ustanovka-lokalnogo-modulya-chestnogo-znaka.md), а затем — к [настройке взаимодействия драйвера ККТ с ЕСМ](../Настройка%20интеграции%20с%20ТС%20ПИоТ/nastroyka-integracii-s-ts-piot.md#настройка-взаимодействия-драйвера-ккт-с-есм).

---

**Теги:** Маркировка, Торговое оборудование, ЕСМ, Единый Сервисный Модуль, установка, дистрибутив, драйвер ККТ, проверка подключения
