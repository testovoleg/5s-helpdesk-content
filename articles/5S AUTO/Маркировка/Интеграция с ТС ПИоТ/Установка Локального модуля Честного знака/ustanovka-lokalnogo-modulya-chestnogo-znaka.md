...
Установку ЛМ ЧЗ следует выполнять после [установки Единого Сервисного Модуля (ЕСМ)](../Установка%20Единого%20Сервисного%20Модуля%20%28ЕСМ%29/ustanovka-edinogo-servisnogo-modulya-esm.md). Общий порядок настройки описан в статье [«Настройка интеграции с ТС ПИоТ»](../Настройка%20интеграции%20с%20ТС%20ПИоТ/nastroyka-integracii-s-ts-piot.md).
...
Файл требуется разархивировать и запустить с помощью PowerShell (кликнуть правой клавишей мыши и выбрать в меню вариант «Выполнить с помощью PowerShell»).
...
После установки и настройки ЕСМ и ЛМ ЧЗ следует перейти в программу 5S AUTO для [настройки оборудования](../Настройка%20интеграции%20с%20ТС%20ПИоТ/nastroyka-integracii-s-ts-piot.md#настройка-оборудования-в-программе).
