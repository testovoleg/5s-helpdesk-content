...
> *Функционал доступен с релиза **2.8.3**. Функционал индикации проверки "криптохвостов" – начиная с релиза 2.8.3.26. Разрешительный режим — начиная с релиза 2.8.1, реализация ТС ПИоТ — в релизе 2.8.3.58. Функционал дорабатывается*
