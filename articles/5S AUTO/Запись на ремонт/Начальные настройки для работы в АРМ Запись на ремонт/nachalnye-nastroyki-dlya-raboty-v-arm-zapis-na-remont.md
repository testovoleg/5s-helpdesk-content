...
<table><tr><td><b>Время чтения:</b> 7 мин.</td><td><b>Обновлено:</b> 22.06.2026</td></tr></table>
...
Требуется задать наименование графика, выбрать периодичность (рекомендуется «Произвольный»). Установить «Детальный график», — это нужно для синхронизации с [Табелем](../../Персонал%20и%20мотивация/Табель%20учета%20рабочего%20времени/tabel-ucheta-rabochego-vremeni.md), — выбрать смену и задать непосредственно график работы.
...
*Ряд примеров настройки графиков приведен в уроке «[Как настроить график работы цеха](../../../../lessons/Урок%208.%20Запись%20на%20ремонт/Как%20настроить%20график%20работы%20цеха/kak-nastroit-grafik-raboty-cekha.md)».*
