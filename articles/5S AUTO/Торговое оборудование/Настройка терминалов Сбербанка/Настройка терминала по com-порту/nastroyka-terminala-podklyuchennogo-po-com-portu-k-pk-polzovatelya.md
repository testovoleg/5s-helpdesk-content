...
<table><tr><td><b><i>Важно: При этом у пользователя право «Разрешить ручную авторизацию безналичных платежей» должно стоять в значении «Нет»<a href="#snoska">*</a>.</i></b></td></tr></table>

<a id="snoska"></a>*\*Без этого не будет работать.*
