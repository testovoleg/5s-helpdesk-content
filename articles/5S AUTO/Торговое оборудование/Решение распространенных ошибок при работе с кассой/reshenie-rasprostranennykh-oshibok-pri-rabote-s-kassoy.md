...
1. *Найти разницу и попытаться исправить ситуацию.*
   ...
   **1)** чек был изменен кем-то из сотрудников – в данном случае следует сравнить все данные с тем, что ушло в ОФД, и по возможности исправить в программе;<br>
   **2)** пробили чек по постоплате – в данном случае следует сделать возврат и пробить правильно;<br>
