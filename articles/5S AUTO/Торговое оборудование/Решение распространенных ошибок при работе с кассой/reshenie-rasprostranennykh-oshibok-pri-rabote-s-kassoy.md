...
2. *Инкассировать все остатки по кассе.*<br><br>
   ...
   **1)** сформировать Z-отчет:<br>
   ![Z-отчет](attachments/07-z-otchet.png)
   **2)** нажать на Фронте кассира кнопку "Изъятие" – в программе будет создан документ "Инкассация". Следует перейти в созданный документ и дозаполнить его по всем типам оплаты – можно использовать автозаполнение по кнопке "Заполнить остатками по кассе ККМ" (см. ниже).<br>
   Либо (например, если сумма “0”) создать документ "Инкассация" вручную:<br>
   ![Инкассация в меню](attachments/08-inkassaciya-v-menyu.png)
   И заполнить остатками:<br>
   ![Инкассация - Заполнить остатками](attachments/09-inkassaciya-zapolnit-ostatkami.png)
   Документ должен быть заполнен всей суммой, которую выдаст программа, по всем типам оплаты:<br>
   ![Инкассация - Заполнено](attachments/10-inkassaciya-zapolneno.png)
