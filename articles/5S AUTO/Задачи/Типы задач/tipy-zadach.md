...
**3) Смена исполнителя** — смена исполнителя задачи при смене ответственного за [сделку](../../CRM/Работа%20со%20сделкой/rabota-so-sdelkoy.md): при смене ответственного в сделке будет автоматически меняться исполнитель задачи.
