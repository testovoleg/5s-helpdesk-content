...
| **Управляющий директор** | На данный момент не используется при адресации<br>Пользователи с данной должностью видят все записи в [Журнале передачи смен](../../Автосервис/Передача%20смен/peredacha-smen.md) |
| **Хранилище задач (не назначать пользователям)** | Служебная запись, не подлежит назначению на пользователя |

Отдельный блок ролей предусмотрен для работы с функционалом *"[Контроль неликвидов](https://5systems.ru/taxonomy/term/227)":* см. описание ролей в [статье](../../Контроль%20неликвидов/Настройка%20прав%20доступа%20к%20Контролю%20неликвидов/nastroyka-prav-dostupa-k-kontrolyu-nelikvidov.md#список-ролей).
