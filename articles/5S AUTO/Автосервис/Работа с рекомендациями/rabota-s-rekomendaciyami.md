...
Настройка приглашений по рекомендациям производится в Мастере настройки системы — см. [Мастер настройки системы → Приглашение по рекомендациям](../../Администрирование%20и%20настройка%20системы/Мастер%20настройки%20системы/master-nastroyki-sistemy.md#приглашение-по-рекомендациям).
