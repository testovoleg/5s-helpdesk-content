...
| Автоработы | Группа [авторабот](https://5systems.ru/help/avtoraboty-0) для данной модели по умолчанию.<br>Выбирается из справочника «Автоработы». |
...
*Подробнее см. статью [Модели двигателей и КПП](https://5systems.ru/help/modeli-dvigateley-i-kpp).*
...
**Теги:** модели автомобилей, варианты комплектации, цвета, типы кузовов, типы двигателей, типы КПП, типы салона, справочники
