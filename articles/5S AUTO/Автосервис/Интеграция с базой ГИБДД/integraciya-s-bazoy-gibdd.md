...
Предварительно для настройки интеграции с сервисом должна быть настроена интеграция с [API 5S AUTO](../../Администрирование%20и%20настройка%20системы/API%205S%20AUTO/api-5s-auto.md).
...
**Теги:** Расшифровка автомобиля, гибдд, интеграция, расшифровка автомобиля по гос. номеру, vin, api 5s auto
