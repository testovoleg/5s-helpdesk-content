...
| Поле | Содержимое |
| --- | --- |
| Параметры автомобиля | Указывается [модель автомобиля](https://5systems.ru/help/modeli-avtomobiley-i-drugie-spravochniki) и вариант его *комплектации*. Значения выбираются из справочников «Модели автомобилей» и «Варианты комплектации» соответственно. Введенные значения автоматически отображаются в наименовании автомобиля |
