...
| Кнопка «Расшифровать а/м» ![Кнопка расшифровать по VIN](attachments/btn-rasshifrovat-vin.png) | По кнопке осуществляется переход в обработку «Идентификация автомобилей», где можно [расшифровать автомобиль](../Расшифровка%20автомобиля%20по%20VIN/rasshifrovka-avtomobilya-po-vin.md) при помощи TecDoc и онлайн-каталога |
...
| Кнопка «Расшифровать а/м по гос.номеру» ![Кнопка расшифровать по гос. номеру](attachments/btn-rasshifrovat-gosnomer.png) | Нажатием на кнопку с эмблемой ГИБДД осуществляется [расшифровка автомобиля по гос.номеру](../Интеграция%20с%20базой%20ГИБДД/integraciya-s-bazoy-gibdd.md). Данные отображаются на вкладке «Комментарий».<br>*Функционал доступен при условии настроенной интеграции с базой ГИБДД, каждый запрос платный* |
...
Из документов «Заявка на ремонт», «[Заказ-наряд](../Работа%20с%20Заказ-нарядами/Заказ-наряды/zakaz-naryady.md)», «Заказ покупателя» карточка автомобиля и справочник «Автомобили» открываются кнопками «Выбрать» и «Открыть» в параметре «Автомобиль»:
...
Далее необходимо заполнить все поля карточки автомобиля вручную на основе карточки СТС, либо при помощи инструментов [расшифровки автомобиля по VIN](../Расшифровка%20автомобиля%20по%20VIN/rasshifrovka-avtomobilya-po-vin.md) или [по гос. номеру](../Интеграция%20с%20базой%20ГИБДД/integraciya-s-bazoy-gibdd.md).
