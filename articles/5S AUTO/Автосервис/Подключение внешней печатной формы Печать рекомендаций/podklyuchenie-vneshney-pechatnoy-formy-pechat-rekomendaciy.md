...
Для подключения внешней формы печати рекомендаций в справочнике **«Внешние печатные формы»** в папке «Внешние печатные формы» создается элемент «Печать рекомендаций», задается наименование, выбирается вид обработки «Печатная форма». Сама форма загружается нажатием на кнопку «Загрузить» ![Кнопка Загрузить](attachments/btn-zagruzit.jpg). *Файл для загрузки:*
