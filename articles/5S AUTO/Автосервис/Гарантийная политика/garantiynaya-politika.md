...
Значение в колонку *«Вид гарантии»* подставляется из преднастроенного справочника «Виды гарантии» вручную или автоматически, если для [*Автоработы*](../Автоработы/avtoraboty.md) или [*Номенклатуры*](https://5systems.ru/help/nomenklatura-0) настроен параметр «Вид гарантии».
