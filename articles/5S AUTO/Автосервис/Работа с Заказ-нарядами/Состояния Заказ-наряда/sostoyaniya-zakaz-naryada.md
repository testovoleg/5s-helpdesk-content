...
<table><tr><td><b>Время чтения:</b> 7 мин.</td><td><b>Обновлено:</b> 18.06.2025</td></tr></table>
...
*Примечание:* Если у вас часто пропадают состояния заказ-наряда, рекомендуется в [праве](../../../Пользователи%20и%20права/Установка%20прав%20и%20настроек%20пользователя/ustanovka-prav-i-nastroek-polzovatelya.md) *«Право доступа ВидыСостоянийЗаказНарядов»* установить значение *«Чтение»* для всех сотрудников, кроме администратора и/или директора.

---

**Теги:** Работа с Заказ-нарядом, заказ-наряд, состояния заказ-наряда, справочник состояний, цветовая индикация, доступность состояний
