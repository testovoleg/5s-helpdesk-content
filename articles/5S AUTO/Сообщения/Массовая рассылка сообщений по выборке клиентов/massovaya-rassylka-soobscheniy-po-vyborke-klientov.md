...
2. В окне с настройками отчета укажите параметры отбора (см. примеры в статье [*Отчет "Отбор по контрагентам"*](../../Отчеты/Отчет%20Отбор%20по%20контрагентам/otchet-otbor-po-kontragentam.md)) и нажмите кнопку "ОК":<br>
