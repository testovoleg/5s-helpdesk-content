...
См. основную статью: [Интеграция с сообществом ВКонтакте (VK)](https://www.5systems.ru/help/integraciya-s-soobschestvom-vkontakte-vk).
...
Затем перейти в программе в настройках *интеграции с VK* к *редактированию учетной записи* (подробнее см. в [основной статье](https://www.5systems.ru/help/integraciya-s-soobschestvom-vkontakte-vk#redakt)), переключить флаг *“Приложение → Индивидуальное”* и ввести скопированный ID в поле *“Идентификатор приложения”:*
