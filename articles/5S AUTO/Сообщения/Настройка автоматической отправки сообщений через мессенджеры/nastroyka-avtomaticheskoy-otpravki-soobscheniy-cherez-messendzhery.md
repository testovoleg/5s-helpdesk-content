...
1. пишем наименование события "Автомобиль готов",<br>
2. в качестве источника выбираем документ "Заказ-наряд",<br>
3. в качестве события выбираем "После проведения",<br>
