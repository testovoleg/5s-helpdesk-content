...
Зададим шаблон сообщения, на основе которого будет формироваться текст сообщения. Можно создать шаблон заранее и выбрать его, а можно создать шаблон непосредственно из формы создания действия (как настроить шаблон см. *[Шаблоны сообщений](https://5systems.ru/help/shablony-soobscheniy)*). Выберем уже преднастроенный шаблон:
