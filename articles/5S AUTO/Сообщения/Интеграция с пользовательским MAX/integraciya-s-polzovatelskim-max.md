...
Предварительно в программе должна быть настроена интеграция с [API 5S AUTO](../../Администрирование%20и%20настройка%20системы/API%205S%20AUTO/api-5s-auto.md), а также получены параметры доступа к инстансу в ЛК GREEN API (см. [выше](#шаг-3-получение-параметров-доступа-к-инстансу)).
