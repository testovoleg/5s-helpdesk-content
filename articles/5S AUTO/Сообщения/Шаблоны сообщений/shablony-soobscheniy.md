...
*Примечание: В данной статье рассматривается настройка типичных шаблонов сообщений. Настройка шаблонов WhatsApp Business API имеет свои специфические особенности, которым посвящена отдельная статья "[Настройка шаблонов WhatsApp Business API](https://5systems.ru/help/nastroyka-shablonov-whatsapp-business-api)".*
...
Для использования шаблона при отправке сообщений через [Ленту событий](https://5systems.ru/help/lenta-sobytiy) необходимо произвести настройку на вкладке "Заменяемость" — добавить новую строку, в которую автоматически подтянется шаблон, и включить параметр *"Использовать для отправки из ленты":*

![Лента событий - Настройка шаблона сообщения](attachments/14-lenta-sobytiy-nastroyka-shablona-soobscheniya.png)

Подробнее см. в статье *[Лента событий → Использование шаблона для отправки сообщения](https://5systems.ru/help/lenta-sobytiy#shabl)*.
