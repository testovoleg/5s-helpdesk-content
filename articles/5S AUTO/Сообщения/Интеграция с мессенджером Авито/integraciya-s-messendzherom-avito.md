...
<table><tr><td><b>Время чтения:</b> 9 мин.</td><td><b>Обновлено:</b> 29.12.2025</td></tr></table>
...
Предварительно в программе должна быть настроена интеграция с [API 5S AUTO](../../Администрирование%20и%20настройка%20системы/API%205S%20AUTO/api-5s-auto.md), а также получены *ключи доступа* в ЛК сайта Авито (см. [выше](#keys)).
