...
Интеграция с *платформой объявлений* ***Авито*** позволяет вести переписку с клиентами по объявлениям непосредственно в программе 5S AUTO и в [контакт-центре 5S Chat](https://www.5systems.ru/help/kontakt-centr-5s-chat). Интеграция актуальна для автосервисов и магазинов запчастей, которые используют сервис Авито для привлечения клиентов.
...
Когда клиент пишет сообщение по объявлению в Авито, в системе создается новая [сделка](https://www.5systems.ru/help/rabota-so-sdelkoy), в нее подтягивается диалог:
...
Переписка с клиентом ведется через [Ленту событий](https://5systems.ru/help/lenta-sobytiy), открытую из формы сделки:
