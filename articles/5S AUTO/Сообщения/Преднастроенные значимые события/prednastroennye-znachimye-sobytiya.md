...
Для настройки параметров значимых событий предусмотрен [*Мастер настройки системы*](../../Администрирование%20и%20настройка%20системы/Мастер%20настройки%20системы/master-nastroyki-sistemy.md#настройка-отправки-сообщений).
...
1. Изменить шаблон текста сообщения — для этого сначала нужно перейти к редактированию действия:<br>
   ![Значимые события - Переход к редактированию действия](attachments/03-znachimye-sobytiya-perehod-k-redaktirovaniyu-deystviya.png)
   затем открыть для редактирования шаблон сообщения:<br>
   ![Редактирование шаблона сообщения действия](attachments/04-redaktirovanie-shablona-soobscheniya-deystviya.png)
2. Указать другой состав и порядок каналов доставки сообщения:<br>
   ![Каналы доставки действия](attachments/05-kanaly-dostavki-deystviya.png)
3. Включить/выключить отправку печатных форм документов или изменить отправляемые печатные формы:<br>
...
Подробнее см. статью "[Запрос на отзыв довольного клиента об автосервисе](../../../../tips/5S%20AUTO/Практики/Как%20настроить%20запрос%20на%20отзыв%20довольного%20клиента%20об%20автосервисе/zapros-na-otzyv-dovolnogo-klienta-ob-avtoservise.md)".
...
При записи документа *["Опрос"](../../Управление%20качеством%20обслуживания/Опрос%20клиента%20о%20качестве%20обслуживания/opros-klienta-o-kachestve-obsluzhivaniya.md)*, в котором указано недовольство клиента качеством обслуживания, автоматически создается документ [*"Жалоба"*](../../Управление%20качеством%20обслуживания/Обработка%20жалоб%20от%20клиентов/obrabotka-zhalob-ot-klientov.md).
...
При записи документа [*"Жалоба"*](../../Управление%20качеством%20обслуживания/Обработка%20жалоб%20от%20клиентов/obrabotka-zhalob-ot-klientov.md), в котором установлено:

1. Состояние = "Проверена"
2. Жалоба справедлива = "Да"

Автоматически открывается для создания документ [*"Нарушение"*](../../Персонал%20и%20мотивация/Выявление%20и%20разбор%20нарушений/vyyavlenie-i-razbor-narusheniy.md).
