...
У контрагента нет договора с видом **«Прочее»** и признаком **«Прочее»** — по той организации и тому подразделению, по которым закрывается смена. Именно такой договор программа подставляет в инкассацию, и, не находя его, либо создает новый (либо выдает предупреждение).
