...
2. Нажмите «Добавить». В поле «Смену сдал» выберите мастера-консультанта, который передает смену, в поле «Смену принял» – сменщика. В поле «Период передачи смены, начиная с … по» укажите период, за который нужно передать сделки и задачи.
