...
3. Если код был выведен из оборота в программе, скорее всего, он числится выведенным и в «Честном знаке». Порядок действий:
   - обратитесь в техподдержку «Честного знака», чтобы скорректировать статус кода и вернуть его в оборот;
   - в зависимости от ответа техподдержки оформите в программе документ «Ввод в оборот кодов маркировки» (см. п. 2);
   - после этого исправьте документы, которые не проводились, и проведите их повторно.

   Если товар нужно продать срочно, не дожидаясь корректировки, замените его в документе на аналогичный товар без проблем с маркировкой.
