...
Доступ к справочнику «Автоработы» задается правом *«Право доступа Автоработы»* в группе прав *«Справочники» → «Права доступа справочников»*. Кроме значений «Редактирование», «Возможность чтения» и «Нет доступа» у этого права есть значение *«Редактирование по группам»*: сотрудник может изменять только автоработы из тех групп справочника, которые для него отмечены. Автоработы из остальных групп он видит и подбирает в документы, но изменить не может: поля карточки и кнопка «Записать» заблокированы. Создавать новые автоработы и подгруппы можно только внутри отмеченных групп; добавить новую работу или группу в корень справочника при этом праве нельзя.
...
*Примечание:* При значении «Редактирование по группам» сотрудник не сможет создавать автоработы и группы (папки) в корневой папке справочника «Автоработы», а также в группах, к которым ему не разрешен доступ. В группах, к которым доступ предоставлен, он сможет создавать и автоработы, и подгруппы.
