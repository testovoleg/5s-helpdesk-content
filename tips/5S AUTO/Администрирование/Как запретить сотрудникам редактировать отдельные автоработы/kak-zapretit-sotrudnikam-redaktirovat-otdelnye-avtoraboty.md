...
> *Комментарий: проверить, что при значении «Редактирование по группам» автоработы из неотмеченных групп по-прежнему можно подбирать в заказ-наряд и другие документы (в тексте это утверждается, в тикете не проверялось).*
