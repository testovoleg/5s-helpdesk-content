...
> *Комментарий: в тикете клиент пишет, что после такой настройки у мастера-приемщика пропадает возможность создавать работы. Как должно быть настроено, чтобы была возможность их создавать??*
...
> *Комментарий: проверить, что при значении «Редактирование по группам» автоработы из неотмеченных групп по-прежнему можно подбирать в заказ-наряд и другие документы (в тексте это утверждается, в тикете не проверялось). Для проверки: тестовому пользователю «Право доступа Автоработы» = «Редактирование по группам», на вкладке «Доступ по группам справочников: Автоработы» отметить все группы, кроме «Фиксированные»; перезайти под ним, подобрать в заказ-наряд работу из группы «Фиксированные», попробовать изменить ее карточку, а также создать новую автоработу в разрешенной группе (см. комментарий выше).*
