...
2. Откройте «Права и настройки» (*Администрирование → Сервис → Пользователи и права → Установка прав и настроек* либо кнопка «Права и настройки» в справочнике «Пользователи») и выберите объект настройки: шаблон прав должности или конкретного пользователя.
3. На вкладке «Дерево прав и настроек» в группе «Права доступа справочников» найдите право «Право доступа Автоработы» и установите значение «Редактирование по группам»:

   ![Право доступа Автоработы – Редактирование по группам](attachments/01-pravo-dostupa-avtoraboty-redaktirovanie-po-gruppam.png)

4. Перейдите на вкладку «Доступ по группам справочников: Автоработы», нажмите «Заполнить» и в окне «Выбор группы справочника» отметьте группы, которые сотруднику разрешено редактировать. Группу с защищенными автоработами не отмечайте:

   ![Доступ по группам справочников – Автоработы](attachments/02-dostup-po-gruppam-spravochnikov-avtoraboty.png)
