...
Доступ к справочнику «Автоработы» задается правом *«Право доступа Автоработы»* в группе прав *«Справочники» → «Права доступа справочников»*. Кроме значений «Редактирование», «Возможность чтения» и «Нет доступа» у этого права есть значение *«Редактирование по группам»*: сотрудник может изменять только автоработы из тех групп справочника, которые для него отмечены. Автоработы из остальных групп он видит и подбирает в документы, но изменить не может: часть полей карточки закрыта, а изменения в остальных не записываются – кнопка «Записать» недоступна. Создавать новые автоработы и подгруппы можно только внутри отмеченных групп; добавить группу в корень справочника при этом праве нельзя.
...
4. После выбора этого значения становится активной вкладка «Доступ по группам справочников: Автоработы». Перейдите на нее и нажмите «Заполнить» → «Подбор по группам (включение вложенных)». В открывшемся окне отметьте группы, автоработы из которых сотруднику разрешено редактировать (флажок «Устанавливать пометку» должен быть включен), – вложенные группы попадут в список вместе с родительскими. Группу с защищенными автоработами (в примере – «Фиксированные») не отмечайте. Нажмите «Выбрать» – отмеченные группы появятся в списке на вкладке:
   ...
   *Примечание:* Альтернативный вариант заполнения – «Заполнить» → «Заполнить»: в список попадут все группы справочника, после чего снимите галочки с групп, к которым доступа быть не должно. Так удобнее, если закрыть нужно только одну-две группы.

5. Нажмите «Записать». Чтобы настройка вступила в силу, сотруднику нужно перезайти в программу.

*Примечание:* При значении «Редактирование по группам» сотрудник не сможет создавать автоработы и группы в корневой папке справочника «Автоработы», а также в группах, к которым ему не разрешен доступ. В группах (папках), к которым доступ предоставлен, он сможет создавать и автоработы, и подгруппы.
