...
*Примечание:* Если сотрудник должен создавать новые автоработы, отметьте для него хотя бы одну группу, в которой это разрешено, – вне отмеченных групп создание недоступно.
