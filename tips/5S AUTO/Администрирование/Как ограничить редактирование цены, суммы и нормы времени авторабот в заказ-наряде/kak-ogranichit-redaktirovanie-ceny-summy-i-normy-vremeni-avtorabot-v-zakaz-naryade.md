...
Права 1 и 2 закрывают столбцы строки от ручного редактирования, право 3 определяет, что пересчитывается при изменении суммы. Столбец «Сумма» этими правами не закрывается.
