...
*Примечание:* На текущий момент закрыть для редактирования сумму и итоговую стоимость авторабот с фиксированной стоимостью нет возможности: столбец «Сумма» остается доступным при любых значениях описанных прав.
