...
Редактирование цены и суммы в табличных частях документов регулируется правами в «Правах и настройках» (как перейти к ним, см. в статье «[Установка прав и настроек пользователя](../../../../articles/5S%20AUTO/Пользователи%20и%20права/Установка%20прав%20и%20настроек%20пользователя/ustanovka-prav-i-nastroek-polzovatelya.md#переход-к-установке-прав-и-настроек)»). Право задается на шаблон прав должности или на конкретного пользователя; оба права ниже находятся в расширенном списке – включите переключатель «Расширенные» (см. «[Основные и расширенные права](../../../../articles/5S%20AUTO/Пользователи%20и%20права/Установка%20прав%20и%20настроек%20пользователя/ustanovka-prav-i-nastroek-polzovatelya.md#основные-и-расширенные-права)»). В зависимости от того, что именно нужно закрыть, используется одно из двух прав.
...
В группе *«Автосервис»* установите право *«Запрет редактирования нормочаса и цены авторабот»* в значение «Да». Право действует только на автоработы: их цену и стоимость нормочаса пользователь изменить не сможет, при этом норма времени и сумма строки остаются доступными для редактирования. Цены товаров это право не затрагивает.
