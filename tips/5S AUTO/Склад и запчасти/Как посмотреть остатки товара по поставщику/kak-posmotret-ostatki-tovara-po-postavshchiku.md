...
Как посмотреть остатки товара по конкретному поставщику?
...
*Примечание:* при первом открытии, возможно, потребуется сначала сохранить вариант отчета — нажмите кнопку **«Загрузить настройки по умолчанию»** и выберите вариант **«Остатки партий товаров»**.

![Кнопка «Загрузить настройки по умолчанию» в настройках отчета](attachments/03-sohranenie-varianta.png)
...
![Остатки партий товаров с отбором по поставщику](attachments/04-otchet.png)

В примере отобраны остатки по поставщику «Авто-Евро» — 27 единиц на 83 363,34 руб.
...
- Как посмотреть остатки товара по поставщику
- Нужен отчёт по остаткам по конкретному поставщику. Как посмотреть этот отчёт

## Теги

остатки, партии товаров, поставщик, контрагент, отчеты, аналитика, отбор, склад
