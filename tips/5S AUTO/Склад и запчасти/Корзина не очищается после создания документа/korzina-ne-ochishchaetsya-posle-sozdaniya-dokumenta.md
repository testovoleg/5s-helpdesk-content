...
- Корзина не очищается после создания документа
- Позиции остаются в Корзине после переноса в заказ
- Раньше Корзина очищалась, а теперь нет
- Как включить удаление использованных корзин
- Где найти право по удалению корзин
