...
Для текущего пользователя настроено [ограничение видимости складов](../../../../articles/5S%20AUTO/Администрирование%20и%20настройка%20системы/Настройка%20видимости%20складов/nastroyka-vidimosti-skladov.md): у него нет доступа к проведению документов по тому складу, который указан в документе.
...
Подробнее, как настраивается видимость складов для пользователей, см. в статье «[Настройка видимости складов](../../../../articles/5S%20AUTO/Администрирование%20и%20настройка%20системы/Настройка%20видимости%20складов/nastroyka-vidimosti-skladov.md)».

## Похожие вопросы

- Не получается провести документ (нет доступа к складу)
- Не получается провести реализацию
- Не проводится реализация
- Не получается провести поступление товаров
- Не проводится поступление
- Меняю время, но документ не проводится

## Теги

склад, доступ к складам, видимость складов, права пользователя, не проводится документ, запрет проведения, служебные сообщения
