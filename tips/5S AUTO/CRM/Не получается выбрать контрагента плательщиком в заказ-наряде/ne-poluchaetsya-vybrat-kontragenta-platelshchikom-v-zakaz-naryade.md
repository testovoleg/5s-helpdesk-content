...
В заказ-наряде не получается указать нужного контрагента в поле «Плательщик»: поле остается пустым, а в служебных сообщениях программа пишет:
