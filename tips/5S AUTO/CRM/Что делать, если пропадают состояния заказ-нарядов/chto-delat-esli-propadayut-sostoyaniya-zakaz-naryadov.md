...
Узнать, кем была изменена настройка, можно через обработку **«История объекта»**: для этого выделите курсором нужное состояние и перейдите через меню справочника *«Действия → История объекта»*. *Примечание:* История объекта может подгружаться несколько минут.
