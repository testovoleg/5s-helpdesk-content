...
- Что делать, если не срабатывает скидка на строку
- Скидка выбрана, но сумма не изменилась
- Не заполняется процент скидки в заказ-наряде
- Почему скидка не применяется к некоторым товарам
- Как задать скидку для нужного типа номенклатуры
