...
- В печатной форме заказ-наряда не выводится гос. номер автомобиля
- В карточке автомобиля номер есть, а в печати заказ-наряда его нет
- Почему в старых заказ-нарядах пустой гос. номер
- Как добавить гос. номер в уже закрытый заказ-наряд
- Где хранится история характеристик автомобиля
