...
Подробнее — в статьях «[Настройка внутренних телефонов сотрудников](../../../../articles/5S%20AUTO/Телефония/Настройка%20внутренних%20телефонов%20сотрудников/nastroyka-vnutrennikh-telefonov-sotrudnikov.md)» и «[Пользователи](../../../../articles/5S%20AUTO/Пользователи%20и%20права/Пользователи/polzovateli.md#регистр-внутренние-телефоны-пользователей-текущей-смены)».
...
![Должность «Оператор кол-центра» на вкладке «Сведения адресации»](attachments/03-dolzhnost-crm.png)

Подробнее — в статье «[Адресация задач в CRM по исполнителям](../../../../articles/5S%20AUTO/Задачи/Адресация%20задач%20в%20CRM%20по%20исполнителям/adresaciya-zadach-v-crm-po-ispolnitelyam.md)».
...
![Галочка «Пользователь для web-сервисов»](attachments/04-polzovatel-dlya-web-servisov.png)

Подробнее — в статье «[Пользователи](../../../../articles/5S%20AUTO/Пользователи%20и%20права/Пользователи/polzovateli.md#вкладка-параметры-пользователя)».
...
![Способ уведомления «Открывать форму объекта»](attachments/05-sposob-uvedomleniya.png)
...
Подробнее — в статье «[Настройка параметров уведомлений](../../../../articles/5S%20AUTO/CRM/Настройка%20параметров%20уведомлений/nastroyka-parametrov-uvedomleniy.md)».

После изменения настроек сотруднику нужно перезайти в программу.

## Материалы для изучения

- «[Настройка внутренних телефонов сотрудников](../../../../articles/5S%20AUTO/Телефония/Настройка%20внутренних%20телефонов%20сотрудников/nastroyka-vnutrennikh-telefonov-sotrudnikov.md)» — постоянные и меняющиеся номера, заполнение регистра.
- «[Пользователи](../../../../articles/5S%20AUTO/Пользователи%20и%20права/Пользователи/polzovateli.md#вкладка-параметры-пользователя)» — вкладка «Параметры пользователя»: внутренний номер и галочка для web-сервисов.
- «[Адресация задач в CRM по исполнителям](../../../../articles/5S%20AUTO/Задачи/Адресация%20задач%20в%20CRM%20по%20исполнителям/adresaciya-zadach-v-crm-po-ispolnitelyam.md)» — должности в регистре «Сведения адресации» и за какие задачи они отвечают.
- «[Настройка параметров уведомлений](../../../../articles/5S%20AUTO/CRM/Настройка%20параметров%20уведомлений/nastroyka-parametrov-uvedomleniy.md)» — справочник «Уведомления», способы уведомления и личные настройки пользователей.

## Похожие вопросы

- Не открываются карточки лидов и сделок при поднятии трубки
- Не открываются лиды
- У одного из сотрудников перестали автоматически открываться лиды и заявки при поднятии телефонной трубки. Телефоны проверили, у остальных сотрудников все работает штатно. Роли тоже выставлены

## Теги

телефония, входящий звонок, лид, сделка, не открывается карточка, внутренний номер, внутренние телефоны пользователей, сведения адресации, должности CRM, пользователь для web-сервисов, уведомления, открывать форму объекта
