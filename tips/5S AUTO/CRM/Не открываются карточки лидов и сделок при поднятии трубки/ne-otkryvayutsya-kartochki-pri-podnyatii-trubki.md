...
- Не открываются карточки лидов и сделок при поднятии трубки
- У одного сотрудника не всплывает карточка клиента при звонке
- Не работает всплытие сделки по входящему звонку
- Где задается внутренний номер сотрудника
- Почему карточка открывается не у всех
