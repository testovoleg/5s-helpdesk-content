...
- Не открываются карточки лидов и сделок при поднятии трубки
- Не открываются лиды
- У одного из наших сотрудников перестали автоматически открываться лиды и заявки при поднятии телефонной трубки. Телефоны проверили, у остальных сотрудников все работает штатно. Роли тоже выставлены.
