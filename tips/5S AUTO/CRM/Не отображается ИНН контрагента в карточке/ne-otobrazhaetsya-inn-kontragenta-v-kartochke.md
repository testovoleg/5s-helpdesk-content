...
- Не отображается ИНН контрагента в карточке
- В справочнике ИНН есть, а в карточке пусто
- Пропал ИНН у контрагента
- Что такое маска ввода ИНН и где она задается
- Как настроить ИНН для иностранной организации
