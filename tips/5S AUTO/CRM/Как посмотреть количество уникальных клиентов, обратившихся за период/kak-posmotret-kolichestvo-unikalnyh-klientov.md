...
- [Вопрос](#вопрос)
- [Ответ](#ответ)
  - [Статистика по обращениям (анализ заездов)](#статистика-по-обращениям-анализ-заездов)
  - [Обращения клиентов в автосервис](#обращения-клиентов-в-автосервис)
  - [Воронка продаж по закрытым сделкам](#воронка-продаж-по-закрытым-сделкам)
  - [Операционная воронка продаж](#операционная-воронка-продаж)
  - [Сводная ведомость](#сводная-ведомость)
...
Подробнее см. статью [Отчет "Статистика по обращениям"](../../../../articles/5S%20AUTO/Отчеты/Отчет%20Статистика%20по%20обращениям/otchet-statistika-po-obrascheniyam-zaezdam.md).
...
Подробнее см. статью [Отчет «Обращения клиентов в автосервис»](../../../../articles/5S%20AUTO/Отчеты/Отчет%20Обращение%20клиентов%20в%20автосервис/otchet-obrascheniya-klientov-v-avtoservis.md).
...
Подробнее см. статью [Отчет "Воронка продаж по закрытым сделкам"](../../../../articles/5S%20AUTO/Отчеты/Отчет%20Воронка%20продаж%20по%20закрытым%20сделкам/otchet-voronka-prodazh-po-zakrytym-sdelkam.md).
...
Отдельные колонки «Сделки (первичные)» и «Сделки (повторные)» позволяют оценить, сколько новых клиентов обратилось за период, а «Заезды (первичные)» и «Заезды (повторные)» — сколько заказ-нарядов и продаж оформлено по первичным и повторным клиентам:

![Отчет «Операционная воронка продаж»](attachments/09-voronka-operacionnaya-otchet.png)

Кроме количества сделок, отчет показывает конверсию по каждому подразделению и сотруднику: в колонках «Заезды / Запись, %», «Заезды / Обращения, %» и «Записи / Обращения, %» видно, какая доля обращений превратилась в записи и заезды.
...
Подробнее см. статью [Отчет «Операционная воронка продаж»](../../../../articles/5S%20AUTO/Отчеты/Отчет%20Операционная%20воронка%20продаж/otchet-operacionnaya-voronka-prodazh.md).
...
- Как посмотреть количество уникальных клиентов, обратившихся за период
- Каким отчетом можно посмотреть количество уникальных клиентов?
- Каким отчетом можно посмотреть количество уникальных клиентов (обратившихся) за период?
- Существует отчет, где я могу посмотреть новых клиентов списком?

## Теги

отчеты, CRM, уникальные клиенты, первичные обращения, статистика по обращениям, воронка продаж, сводная ведомость
