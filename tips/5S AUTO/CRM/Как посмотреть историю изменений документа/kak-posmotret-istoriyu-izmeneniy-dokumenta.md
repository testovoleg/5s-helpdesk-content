...
- Как посмотреть историю изменений документа
- Кто поменял исполнителя в заказ-наряде
- Кто провел или изменил документ и когда
- Как узнать, какое поле изменилось в документе
- Где посмотреть действия пользователей в программе
