...
- Реквизит «Согласие на обработку персональных данных» не заполнен
- Не сохраняются изменения в карточке частного лица
- Что выбрать в согласии на обработку персональных данных
- Ошибка при записи клиента, перенесенного из другой базы
