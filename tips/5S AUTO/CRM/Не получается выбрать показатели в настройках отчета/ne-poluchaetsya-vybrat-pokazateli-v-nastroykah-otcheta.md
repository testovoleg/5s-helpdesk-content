...
4. В дереве прав найдите право **«Устанавливать фильтр по подразделению в отчетах»** (раздел **«ОТЧЕТЫ И ОБРАБОТКИ»**, код 5c221) — [см. скриншот](#pravo) в разделе «Причина».
...
Роль выбирается в карточке пользователя на вкладке **«Доступ»**, в списке **«Доступные роли»** — [см. скриншот](#rol) в разделе «Причина».
