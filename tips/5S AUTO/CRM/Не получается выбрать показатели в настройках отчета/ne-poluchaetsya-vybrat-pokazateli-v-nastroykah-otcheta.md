...
- Не получается выбрать показатели в настройках отчета
- Не ставятся галочки в денежных показателях отчета
- Сняли галочку в отчете и не можем вернуть
- Как дать сотруднику доступ к суммам в отчете
- Что делает право «Устанавливать фильтр по подразделению в отчетах»
