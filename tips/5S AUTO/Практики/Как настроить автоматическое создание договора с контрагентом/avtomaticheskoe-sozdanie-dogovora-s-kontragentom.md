# Как настроить автоматическое создание договора с контрагентом

<table><tr><td><b>Обновлено:</b> 30.10.2024</td></tr></table>

<sub>Источник: https://www.5systems.ru/help/avtomaticheskoe-sozdanie-dogovora-s-kontragentom</sub>

## Вопрос

Как сделать, чтобы договор с контрагентом создавался автоматически и соответствовал организации и подразделению документа?
...
Для работы с документами в программе необходимо наличие *[договора взаиморасчетов](../../../../articles/5S%20AUTO/Учет%20взаиморасчетов/Взаиморасчеты%20с%20контрагентами/vzaimoraschety-s-kontragentami.md#договор-взаиморасчетов-с-контрагентом) с контрагентом.*
...
*Подробнее о настройке прав см. статью “[Установка прав и настроек пользователя](../../../../articles/5S%20AUTO/Пользователи%20и%20права/Установка%20прав%20и%20настроек%20пользователя/ustanovka-prav-i-nastroek-polzovatelya.md#групповая-установка-прав)”.*
...
- [При закрытии кассовой смены создаются новые договоры](../../Касса/При%20закрытии%20кассовой%20смены%20создаются%20новые%20договоры/pri-zakrytii-smeny-sozdayutsya-novye-dogovory.md)

## Похожие вопросы

- Как настроить автоматическое создание договора с контрагентом
- Автоматическое создание договора с контрагентом
- Договор с контрагентом не создается автоматически
- Программа ругается, что договор не соответствует организации документа
- Как включить контроль организации и подразделения в договоре
- Как настроить создание договора с контрагентом
- Как настроить создание договора
- Как создавать договор автоматически на нужную организацию

## Теги

практики, договор, контрагент, автоматическое создание, взаиморасчеты
