...
- «[Отчет «Обращения клиентов в автосервис»](../../../../articles/5S%20AUTO/Отчеты/Отчет%20Обращение%20клиентов%20в%20автосервис/otchet-obrascheniya-klientov-v-avtoservis.md)» — основная статья: подробное описание показателей, уровней группировки, источников обращений и отбора по причинам отказа.
