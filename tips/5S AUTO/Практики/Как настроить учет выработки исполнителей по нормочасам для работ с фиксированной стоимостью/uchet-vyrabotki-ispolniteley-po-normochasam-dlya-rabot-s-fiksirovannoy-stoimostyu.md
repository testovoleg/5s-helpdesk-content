# Как настроить учет выработки исполнителей по нормочасам для работ с фиксированной стоимостью
...
Как настроить учет выработки исполнителей по нормочасам, если у авторабот фиксированная стоимость?
...
- [Как вести учет выработки специалистов по запчастям в Заказ-нарядах](../Как%20вести%20учет%20выработки%20специалистов%20по%20запчастям%20в%20Заказ-нарядах/uchet-vyrabotki-specialistov-po-zapchastyam-v-zakaz-naryadakh.md)

## Похожие вопросы

- Как настроить учет выработки исполнителей по нормочасам для работ с фиксированной стоимостью
- Как учитывать выработку исполнителей по нормочасам для работ с фиксированной стоимостью
- Учет выработки исполнителей по нормочасам для работ с фиксированной стоимостью
- Как посчитать выработку механика по работам с фиксированной ценой
- В отчете «Выработка исполнителей» не считаются нормочасы по фиксированным работам
- Как заполнить нормочасы у автоработы с фиксированной стоимостью

## Теги

практики, выработка, нормочасы, автоработы, фиксированная стоимость, мотивация
