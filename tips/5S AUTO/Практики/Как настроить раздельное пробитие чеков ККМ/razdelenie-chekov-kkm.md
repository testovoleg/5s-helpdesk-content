# Как настроить раздельное пробитие чеков ККМ

<table><tr><td><b>Обновлено:</b> 10.12.2025</td></tr></table>
...
Как настроить раздельное пробитие чеков ККМ по товарам и услугам на разные организации?
...
1. Для возврата оплаты по товарам и по услугам сначала необходимо корректно оформить документы возврата в программе – подробнее см. в статье “[Порядок работы с кассами ККМ](../../../../articles/5S%20AUTO/Касса/Порядок%20работы%20с%20кассами%20ККМ/poryadok-raboty-s-kassami-kkm.md#возврат)”.
...
Форма будет автоматически заполнена данными из документа, следует проверить сумму и нажать кнопку “Пробить чек на возврат”. См. также описание в статье “[Упрощенный фронт кассира](../../../../articles/5S%20AUTO/Касса/Упрощенный%20Фронт%20кассира/uproschennyy-front-kassira.md#возврат-переплаты)”.
...
Наиболее частая причина данной ошибки – выбранный тип оплаты не указан в настройках параметров оборудования. Следует проверить настройки данного ФР – подробнее см. в [статье](../../../../articles/5S%20AUTO/Торговое%20оборудование/Подключение%20кассы%20ККМ/podklyuchenie-kassy-kkm.md#настройка-оборудования).
...
- [Как настроить продажу подакцизных товаров](../Как%20настроить%20продажу%20подакцизных%20товаров%20при%20патентной%20системе%20налогообложения/osobennosti-realizacii-podakciznykh-tovarov.md)
- [Как настроить применение НДС при УСН](../Как%20настроить%20применение%20НДС%20при%20УСН/primenenie-nds-pri-usn.md)
- [Как задать кассира по умолчанию для печати чеков](../../../Оборудование/Кассы%20ККМ/Как%20задать%20кассира%20по%20умолчанию%20для%20печати%20чеков/kak-zadat-kassira-po-umolchaniyu.md)
...
- Как настроить раздельное пробитие чеков ККМ
- Как настроить разделение чеков ККМ
- Разделение чеков ККМ
- Как пробивать товары и работы на разные организации
- Как принимать предоплату и окончательный расчет разными чеками
- Ошибки при раздельном пробитии чеков

## Теги

практики, чеки ккм, разделение чеков, предоплата, касса, подразделения
