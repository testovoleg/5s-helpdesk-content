# Как настроить запрос на отзыв довольного клиента об автосервисе

<table><tr><td><b>Обновлено:</b> 19.07.2024</td></tr></table>

<sub>Источник: https://www.5systems.ru/help/zapros-na-otzyv-dovolnogo-klienta-ob-avtoservise</sub>

## Вопрос

Как настроить автоматический сбор хороших отзывов об автосервисе?
...
Если клиент остался доволен работой автосервиса (выясняется в результате [опроса](../../../../articles/5S%20AUTO/Управление%20качеством%20обслуживания/Опрос%20клиента%20о%20качестве%20обслуживания/opros-klienta-o-kachestve-obsluzhivaniya.md)), можно попросить его оставить отзыв на сайте при помощи следующего механизма.

### Предварительная настройка

*Также см. статьи [Создание типовой анкеты](../../../../articles/5S%20AUTO/Администрирование%20и%20настройка%20системы/Создание%20типовой%20анкеты/sozdanie-tipovoy-ankety.md), [Настройка автоматической отправки сообщений через мессенджеры](../../../../articles/5S%20AUTO/Сообщения/Настройка%20автоматической%20отправки%20сообщений%20через%20мессенджеры/nastroyka-avtomaticheskoy-otpravki-soobscheniy-cherez-messendzhery.md) и [Опрос клиента о качестве обслуживания](../../../../articles/5S%20AUTO/Управление%20качеством%20обслуживания/Опрос%20клиента%20о%20качестве%20обслуживания/opros-klienta-o-kachestve-obsluzhivaniya.md).*
...
*Подробную инструкцию создания шаблонов сообщений см. в статье [Шаблоны сообщений](../../../../articles/5S%20AUTO/Сообщения/Шаблоны%20сообщений/shablony-soobscheniy.md).*
...
- [Как посмотреть список всех отправленных сообщений](../../CRM/Как%20посмотреть%20список%20всех%20отправленных%20сообщений/kak-posmotret-spisok-vseh-otpravlennyh-soobshcheniy.md)
...
- Как настроить отправку ссылки на отзыв после опроса клиента
- Как добавить сервисы (Яндекс, 2ГИС), где клиент может оставить отзыв
- Как сделать шаблон сообщения с запросом отзыва
- Как настроить рассылку запросов на отзыв
- Как настроить сбор отзывов об обслуживании
- Как попросить клиента оставить отзыв на Яндекс Картах или 2ГИС
- Как отправлять клиенту ссылку на отзыв после обслуживания

## Теги

практики, отзыв клиента, шаблон сообщения, автоматическое действие, качество обслуживания
