# Как настроить пакетные предложения
...
Как настроить пакетные предложения, чтобы продавать набор работ и запчастей по единой цене?
...
- Как продавать комплекс услуг по фиксированной цене
- Как сделать комплект деталей для автоработы
- Как добавить пакет работ и запчастей в заказ-наряд

## Теги

практики, пакетные предложения, наборы, ценообразование, продажи
