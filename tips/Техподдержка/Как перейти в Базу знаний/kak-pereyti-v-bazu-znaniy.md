...
> *Статья редактируется: описание относится к старому сайту и будет обновлено под новую Базу знаний.*
...
Для того чтобы перейти в [Базу знаний](../../../articles/), нажмите кнопку «Все статьи» внизу блока «Популярные статьи» на странице [«Помощь»](https://www.5systems.ru/help):
