...
- Буфер обмена всегда пуст
- Не работает Ctrl+C и Ctrl+V в программе
- Не получается вставить пароль в настройки почты
- Программа не видит принтер и оборудование после подключения
