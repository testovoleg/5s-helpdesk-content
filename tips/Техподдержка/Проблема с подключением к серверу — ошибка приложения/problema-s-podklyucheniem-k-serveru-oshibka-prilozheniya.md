...
Программа неожиданно закрывается, а при повторном входе выходит ошибка приложения:

> rdpinit.exe — Ошибка приложения  
> Исключение unknown software exception (0x40000015) в приложении по адресу 0x00007FFAA911B0AA.  
...
**Теги:** сервер, подключение, ошибка приложения, rdpinit.exe, unknown software exception, не печатает принтер, место на диске, техподдержка
