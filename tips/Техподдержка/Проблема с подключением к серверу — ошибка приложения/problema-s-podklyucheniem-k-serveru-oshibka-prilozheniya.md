...
- Проблема с подключением к серверу — ошибка приложения
- Выкидывает из программы, при входе ошибка rdpinit.exe
- unknown software exception при запуске программы
- Перестал печатать принтер, потом вылетела 1С
- Не заходит в программу после сбоя
