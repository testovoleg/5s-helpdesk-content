...
При закрытии кассовой смены запускается обновление терминала, но не доходит до конца: программа зависает либо выдает ошибку 4001, после чего 1С аварийно завершает работу. Терминал остается необновленным.
