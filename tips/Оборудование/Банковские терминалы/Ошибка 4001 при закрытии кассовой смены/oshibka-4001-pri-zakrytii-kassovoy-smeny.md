...
- У нас снова проблема при автоматическом обновлении терминала эквайринга, программа вылетает после продолжительной попытки установки автообновления
- После обновления при попытке принятия оплаты выдает ошибку
- Вылетает программа при закрытии смены
- Постоянно вылетает программа при закрытии смены
