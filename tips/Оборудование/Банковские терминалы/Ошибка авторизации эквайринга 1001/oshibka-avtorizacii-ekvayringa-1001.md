...
4. Выберите «Выход».
5. Выполните повторный вход под учетной записью и запустите 1С.

**3.2. Через 1С** — если вы подключаетесь по ярлыку, например через RemoteApp

1. В интерфейсе 1С выберите **«Файл» → «Открыть»**.
2. В строке пути напишите `logoff`.
3. Нажмите Enter.
4. После завершения сеанса войдите в 1С заново.

**3.3. Через Диспетчер задач на сервере** — способ для системного администратора
