...
Подробнее см. в [статье](../../../../articles/5S%20AUTO/Торговое%20оборудование/Подключение%20кассы%20ККМ/podklyuchenie-kassy-kkm.md#настройка-доступа-порта-через-сторонние-программы).
...
**Шаг 5.** Если для работы с кассой на компьютер установлен VPN (см. в [статье](../../../../articles/5S%20AUTO/Торговое%20оборудование/Подключение%20кассы%20ККМ/podklyuchenie-kassy-kkm.md#настройка-доступа-порта-через-сторонние-программы)), проверьте, подключена ли данная программа:
...
1. брандмауэра ПК, к которому подключена касса, и любых программ, которые могут блокировать внешние подключения;
2. VPN между сервером и локальной сетью РК;
3. занятости кассы другими пользователями (например, открытый фронт кассира);
4. плохого или отсутствующего интернет-соединения.
...
- [Касса не включается](../Касса%20не%20включается/kassa-ne-vklyuchaetsya.md)
- [Оборудование не найдено](../Оборудование%20не%20найдено/oborudovanie-ne-naydeno.md)

## Похожие вопросы

- Ошибки включения кассы
- Касса не включается, программа пишет «Нет связи»
- Фискальный регистратор не установлен — не открывается смена
- Не снимается X-отчёт, касса недоступна
- Сетевая касса перестала подключаться к 1С

## Теги

Торговое оборудование, касса, ККМ, нет связи, фискальный регистратор, оборудование не найдено, VSPE, VPN, сетевая касса, включение кассы
