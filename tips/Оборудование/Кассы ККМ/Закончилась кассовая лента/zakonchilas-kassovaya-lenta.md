...
> **Примечание.** Если ККТ не была применена во время приёма оплаты, необходимо после устранения проблем с кассой пробить чек коррекции — подробнее см. статью [«Использование чека коррекции»](../../../../articles/5S%20AUTO/Касса/Использование%20Чека%20коррекции/ispolzovanie-cheka-korrekcii.md). В случае исправления ошибочно пробитых чеков применение чека коррекции зависит от версии ФФД — подробнее также см. в вышеуказанной статье.
...
Торговое оборудование, касса, ККМ, кассовая лента, тест драйвера ККТ, допечатать, отменить документ, чек коррекции
