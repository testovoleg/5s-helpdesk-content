...
Если во время печати чека или закрытия смены закончилась кассовая лента, касса блокируется.

## Решение

Следует заменить кассовую ленту, затем запустить приложение «Тест драйвера ККТ» и перейти в раздел «ФН».
...
**Теги:** касса, ККМ, кассовая лента, тест драйвера ККТ, допечатать, отменить документ, чек коррекции
