# Недопустимый номер ставки налога 144
...
2. Убедитесь, что установлена актуальная версия тест-драйвера.

Если ставки в документе указаны верно, а ошибка повторяется, значит драйвер не умеет работать с этой ставкой. Обратитесь к вашему системному администратору (или в обслуживающую компанию), чтобы драйвер обновили для работы с новыми ставками НДС — например, 22 %.
