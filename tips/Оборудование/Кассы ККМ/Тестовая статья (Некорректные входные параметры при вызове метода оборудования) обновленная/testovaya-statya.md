# Тестовая статья (Некорректные входные параметры при вызове метода оборудования) обновленная
...
касса, ККМ, фискальный регистратор, ФФД, версия ФФД, карточка оборудования
