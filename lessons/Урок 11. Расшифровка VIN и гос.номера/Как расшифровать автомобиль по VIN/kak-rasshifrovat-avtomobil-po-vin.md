...
2. выберите марку автомобиля и нажмите кнопку-ссылку "Получить все модели":<br>
   ![Расшифровка по VIN сохранение моделей](attachments/16-rasshifrovka-po-vin-sohranenie-modeley.png)
3. нажмите кнопку "Сохранить модели в ИБ":<br>
...
1. выберите модель автомобиля и нажмите кнопку-ссылку "Получить все модификации":<br>
   ![Расшифровка по VIN сохранение модификаций](attachments/18-rasshifrovka-po-vin-sohranenie-modifikaciy.png)
2. нажмите кнопку "Сохранить модификации в ИБ":<br>
