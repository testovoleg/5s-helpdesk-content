...
В открывшемся окне можно увидеть, для каких шаблонов или пользователей назначено данное право, поменять *значение* для определенных шаблонов, а также изменить значение для всех объектов: для этого нужно задать значение у одного шаблона, выделить его и нажать кнопку «Установить для всех» ![Кнопка Установить для всех](attachments/11-knopka-ustanovit-dlya-vseh.jpg). Можно восстановить значение права *по умолчанию* для всех – соответствующей кнопкой ![Кнопка Установить для всех по умолчанию](attachments/12-knopka-ustanovit-dlya-vseh-po-umolchaniyu.jpg).

![Права и настройки - Групповая установка для всех](attachments/13-prava-i-nastroyki-gruppovaya-ustanovka-dlya-vseh.png)
...
![Права и настройки - Доступ](attachments/14-prava-i-nastroyki-dostup.png)

## Завершение настройки

Чтобы сохранить произведенные настройки, требуется обязательно в *Правах и настройках* нажать кнопку ***"Записать"***:

![Права и настройки - Записать](attachments/15-prava-i-nastroyki-zapisat.png)
