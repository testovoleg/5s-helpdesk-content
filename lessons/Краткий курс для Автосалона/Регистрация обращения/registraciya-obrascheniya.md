...
Если сотрудник принял звонок клиента, то новая сделка сразу попадает на этап *“[Выбор автомобиля](https://www.5systems.ru/help/vybor-avtomobilya)”,* т.к. в сделку автоматически подставляется “Ответственный”. В случае если звонок был [пропущен](https://www.5systems.ru/help/rabota-s-propuschennymi-zvonkami), либо при заявке с сайта новая сделка попадает на этап *“Неразобранное”,* и требуется сначала *взять ее в работу* – для этого следует нажать кнопку *“Взять в работу”:*
...
Далее можно переходить к *[подбору автомобиля](https://www.5systems.ru/help/vybor-avtomobilya).*
...
[*Следующий урок "Выбор автомобиля" →*](https://www.5systems.ru/help/vybor-avtomobilya)
