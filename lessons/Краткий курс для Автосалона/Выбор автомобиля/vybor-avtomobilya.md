...
Если а/м в наличии на складе, можно выбрать его в поле “Автомобиль” из справочника автомобилей – при этом автоматически заполняются поля “Комплектация”, “Год выпуска” и “VIN”. Также можно *расшифровать а/м по VIN* – подробнее см. в уроке *"[Создание карточки автомобиля](https://www.5systems.ru/help/sozdanie-kartochki-avtomobilya)"* в [*кратком курсе для автосервиса*](https://www.5systems.ru/taxonomy/term/122).
...
При сохранении изменений сделка переходит на следующий этап *“[Встреча](https://www.5systems.ru/help/vstrecha)”:*
...
- *"[Создание карточки автомобиля](https://www.5systems.ru/help/sozdanie-kartochki-avtomobilya)"* в [Кратком курсе для Автосервиса](https://www.5systems.ru/taxonomy/term/122).
