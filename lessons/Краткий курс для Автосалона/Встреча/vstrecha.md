...
При встрече можно создать *карточку клиента* в программе, либо нужно будет сделать это позже. Под карточкой клиента имеется в виду элемент справочника *"[Контрагенты](../../Урок%203.%20Клиенты%20и%20автомобили/Контрагенты%20и%20контакты/kontragenty-i-kontakty.md)".*
...
- [Контрагенты и контакты](../../Урок%203.%20Клиенты%20и%20автомобили/Контрагенты%20и%20контакты/kontragenty-i-kontakty.md) и [другие](../../../articles/).
