...
Для этого после того как записали в строку Ф. И. О. или имя клиента, ***добавьте их в карточку клиента***. Только при условии, что данные добавлены в карточку, в дальнейшем они автоматически подтянутся в Корзину, Заявку на ремонт, Заказ покупателя или Заказ-наряд.
...
Под карточкой клиента имеется в виду элемент справочника "[Контрагенты](../../Урок%203.%20Клиенты%20и%20автомобили/Как%20работать%20со%20справочником%20«Контрагенты%20и%20контакты»/kontragenty-i-kontakty.md)". При добавлении в справочник программа проверяет, есть ли уже такой номер телефона в системе или нет:
