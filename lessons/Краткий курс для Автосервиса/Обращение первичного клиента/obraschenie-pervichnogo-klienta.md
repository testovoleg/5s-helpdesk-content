...
Под карточкой клиента имеется в виду элемент справочника "[Контрагенты](../../Урок%203.%20Клиенты%20и%20автомобили/Контрагенты%20и%20контакты/kontragenty-i-kontakty.md)". При добавлении в справочник программа проверяет, есть ли уже такой номер телефона в системе или нет:
