...
![Справочник «Графики работ»](attachments/02-skrin.png)
...
- От настройки графика будет зависеть отображаемое время работы в АРМ Запись на ремонт:
  ...
  ![Время работы в АРМ «Запись на ремонт»](attachments/03-skrin.png)
...
![Заполнение графика в табеле учета](attachments/08-skrin.png)
