...
<sub>Источник: https://www.5systems.ru/help/kak-zakryt-smenu</sub>

## Содержание

1. [Способ 1. Обработка “Закрытие кассовой смены”](#способ-1-обработка-закрытие-кассовой-смены)
2. [Способ 2. Обработка "Фронт менеджера"](#способ-2-обработка-фронт-менеджера)
