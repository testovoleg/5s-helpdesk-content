...
2. Добавьте строку в окне подбора:<br>
   ![Рекомендации Добавление Добавить](attachments/01-rekomendacii-dobavlenie-dobavit.png)
3. Заполните строку рекомендацией.<br>
   Выберите конкретную работу или деталь:<br>
   ![Рекомендации Добавление Выбор](attachments/02-rekomendacii-dobavlenie-vybor.png)
   ИЛИ напишите просто в виде комментария (в этом случае рекомендация не может быть перенесена в документ, а отображаться будет при установленном фильтре "Только с текстовым описанием"):<br>
...
2. Кликните правой кнопкой мыши по работе/детали, в контекстном меню выберите пункт "В рек. работы"/"В рек. товары":<br>
