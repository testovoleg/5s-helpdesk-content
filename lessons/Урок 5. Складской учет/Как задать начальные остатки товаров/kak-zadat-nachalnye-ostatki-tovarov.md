...
![Переход в реестр «Ввод остатков товаров»](attachments/01-skrin.png)
...
![Создание документа «Ввод остатков товаров»](attachments/02-skrin.png)
...
![Ввод остатков товаров – склад и статья приходования](attachments/03-skrin.png)
...
![Заполнение из файла](attachments/04-skrin.png)
...
![Загрузка файла с остатками](attachments/05-skrin.png)
...
![Настройка соответствия колонок файла](attachments/06-skrin.png)
...
![Подбор номенклатуры](attachments/07-skrin.png)

Во всплывающем окне “Подбор” выбираем необходимые товары.

![Выбор товаров в подборе](attachments/08-skrin.png)
...
![Добавление товаров вручную](attachments/09-skrin.png)

## Проведение документа

После проверки заполнения документа нажимаем кнопку Провести либо кнопку ОК (запись с проведением и закрытием формы).

![Проведение документа «Ввод остатков товаров»](attachments/10-skrin.png)
