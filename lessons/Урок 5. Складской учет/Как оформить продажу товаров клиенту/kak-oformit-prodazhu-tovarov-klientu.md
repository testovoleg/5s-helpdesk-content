...
![Переход в реестр «Реализация товаров»](attachments/01-skrin.png)

В реестре документов “Реализация товаров” создаем новый документ и выбираем вид хозяйственной операции - Реализация товаров:

![Создание документа «Реализация товаров»](attachments/02-skrin.png)
...
![Реализация товаров – выбор контрагента](attachments/03-skrin.png)
...
![Создание реализации из АРМ «Корзина»](attachments/04-skrin.png)
...
![Реализация на основании заказа покупателя](attachments/05-skrin.png)
...
![Заполнение по документу-основанию](attachments/06-skrin.png)
