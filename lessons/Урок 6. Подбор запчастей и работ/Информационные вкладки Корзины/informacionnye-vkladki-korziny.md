...
На панели **«Информация»** в [Корзине](../../../articles/5S%20AUTO/Проценка%20запчастей%20и%20работ/Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md) представлена детализированная информация по товару или работе, которые активизированы, т. е. выделены на основной панели. Информация разбита на вкладки:
