...
<sub>Источник: https://www.5systems.ru/help/kak-raspechatat-korzinu-ili-otpravit-v-messendzher</sub>
...
Заполненную [Корзину](../../../articles/5S%20AUTO/Проценка%20запчастей%20и%20работ/Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md) можно вывести на печать — для этого следует нажать кнопку на нижней панели **«Печать Корзины»**, отметить нужные параметры и нажать кнопку **«Печать»**:

![Печать Корзины](attachments/01-pechat.png)

Открывшуюся печатную форму можно распечатать на бумаге либо отправить Корзину для согласования клиенту через мессенджер:

![Отправка Корзины в мессенджер](attachments/02-otpravka-v-messendzher.png)
