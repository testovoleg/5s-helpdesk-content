...
Помощник оформления Заказа покупателя позволяет на основании [Корзины](../../../articles/5S%20AUTO/Проценка%20запчастей%20и%20работ/Работа%20в%20АРМ%20Корзина/rabota-v-arm-korzina.md) быстро создать цепочку документов. Рекомендуется использовать, когда требуется создать несколько Заказов поставщику по одному Заказу покупателя.
