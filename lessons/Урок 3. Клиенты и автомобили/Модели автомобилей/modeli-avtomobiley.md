...
В справочник ***"Модели автомобилей"*** заносится информация обо всех моделях [автомобилей](../Автомобили/avtomobili.md), обслуживаемых на предприятии или являющихся собственностью предприятия.
...
2. Из карточки [автомобиля](../Автомобили/avtomobili.md) нажатием на кнопку “Выбрать” в поле “Модель”:<br><br>
...
- *Автоработы* – группа [авторабот](https://5systems.ru/help/avtoraboty) для данной модели по умолчанию. Выбирается из справочника "Автоработы".
- *Поставщик* – выбирается из справочника ["Контрагенты и контакты"](../Контрагенты%20и%20контакты/kontragenty-i-kontakty.md).
