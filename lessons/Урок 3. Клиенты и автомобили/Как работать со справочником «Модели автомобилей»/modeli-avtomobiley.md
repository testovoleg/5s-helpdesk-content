...
1. Из меню программы – *Автосервис → Приемка → Справочники → Марки и модели а/м:*<br>
   ![Модели автомобилей - Расположение](attachments/01-modeli-avtomobiley-raspolozhenie.png)
2. Из карточки [автомобиля](../Как%20работать%20со%20справочником%20«Автомобили»/avtomobili.md) нажатием на кнопку “Выбрать” в поле “Модель”:<br>
   ![Модели автомобилей - Переход из карточки автомобиля](attachments/02-modeli-avtomobiley-perehod-iz-kartochki-avtomobilya.png)
3. Из *сделки* нажатием на кнопку “Выбрать” в поле “Модель”:<br>
