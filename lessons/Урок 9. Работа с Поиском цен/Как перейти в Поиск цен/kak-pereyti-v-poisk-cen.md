...
# Как перейти в Поиск цен

<table><tr><td><b>Время чтения:</b> 2 мин.</td><td><b>Обновлено:</b> 17.06.2022</td></tr></table>

<sub>Источник: https://www.5systems.ru/help/kak-pereyti-v-poisk-cen</sub>

Время просмотра — 1:43 мин.
...
**Теги:** поиск цен, переход в поиск цен, корзина, номенклатура
