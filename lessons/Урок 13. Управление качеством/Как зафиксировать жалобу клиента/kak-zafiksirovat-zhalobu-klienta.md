...
- **Состояние** - состояние жалобы клиента: зафиксирована, разобрана, проверена или закрыта.<br><br>
  ![Жалоба - Состояние](attachments/04-zhaloba-sostoyanie.png)
- **Категория** - категория жалобы клиента. Заполняется элементами из справочника “Категории жалоб клиентов”: предопределенных элементов нет, заполняется самостоятельно.<br><br>
