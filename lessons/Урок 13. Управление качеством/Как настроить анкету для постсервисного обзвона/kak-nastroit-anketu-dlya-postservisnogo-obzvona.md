...
1. Перейти на вкладку "Макет печатной формы" формы редактирования анкеты и нажать кнопку "Заполнить":<br>
   ![Типовые анкеты - Печатная форма](attachments/10-tipovye-ankety-pechatnaya-forma.png)
2. Подкорректировать макет (например, убрать код раздела) и записать изменения:<br>
