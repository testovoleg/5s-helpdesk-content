...
добавляет строку с расчетной оценкой, если ее еще нет, и только в articles/ и lessons/.
"""
...
NO_READING_TIME = ("articles/5S AUTO/Полезное/Последние добавленные статьи",)
