...
![Предварительный просмотр перед переносом в заказ-наряд](attachments/10-predvaritelnyy-prosmotr.png)

> *Комментарий: не хватает скрина формы настройки таблицы соответствий.*
...
![Режим «Передача данных в AudaPad Web»](attachments/11-peredacha-dannyh.png)
