...
![Страница AudaPad Web со списком дел и областью «Учетная запись»](attachments/03-avtorizaciya-audapad.png)
...
![Выбор задания и калькуляции для загрузки в заказ-наряд](attachments/04-vybor-dela-i-kalkulyacii.png)

> *Комментарий: не хватает скринов — форма настройки таблицы соответствий, предварительный просмотр загрузки и заказ-наряд с загруженными работами и запчастями.*
