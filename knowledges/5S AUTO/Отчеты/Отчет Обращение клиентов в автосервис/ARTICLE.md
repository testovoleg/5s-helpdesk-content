...
Отчет строится по сделкам на основании даты изменения [этапа сделки](https://www.5systems.ru/help/kanban-sdelok#sdelkaietapy).
...
Источник обращения определяется автоматически на основании причины создания [сделки](https://www.5systems.ru/help/rabota-so-sdelkoy):

     ●   *Телефонный звонок* – это входящий звонок, когда оператор взял трубку и пообщался с клиентом.
     ●   *Пропущенный звонок* – показатель попадает в этот раздел, если звонок, на основании которого была создана сделка, был [пропущен](https://www.5systems.ru/help/rabota-s-propuschennymi-zvonkami) (даже если позже по этому звонку перезвонил оператор и записал клиента).
...
В число исходящих обращений попадают сделки, обращения по которым были инициированы сотрудниками компании путем механизмов “[Приглашения по рекомендациям](https://www.5systems.ru/help/rabota-s-rekomendaciyami#priglash_po_rek)” и “[Приглашения на ТО](https://www.5systems.ru/help/priglasheniya-na)”:
