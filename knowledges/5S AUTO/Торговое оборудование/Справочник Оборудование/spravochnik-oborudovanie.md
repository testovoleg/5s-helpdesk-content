...
Карточка оборудования открывается двойным кликом по нужной строке справочника. Реквизиты собраны на трех вкладках: **«Типовые настройки»**, **«Список параметров устройства»** и **«Подключение к ТС ПИоТ»**.
...
Первый блок вкладки **«Типовые настройки»**:
...
Второй блок вкладки **«Типовые настройки»**:
...
В поле внизу карточки отображается состояние оборудования на текущий момент. В программе предусмотрены следующие варианты:
