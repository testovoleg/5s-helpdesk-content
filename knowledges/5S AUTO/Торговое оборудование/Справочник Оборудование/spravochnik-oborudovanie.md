...
- [Управление оборудованием](#управление-оборудованием)
  - [Меню «Оборудование»](#меню-оборудование)
...
Как правило, настройки оборудования выполняются в процессе подключения, но иногда требуется изменить настройки уже подключенного устройства. В этой статье рассматриваются реквизиты элемента справочника «Оборудование» и дополнительные настройки параметров.
...
Карточка оборудования открывается двойным кликом по нужной строке справочника. Реквизиты собраны на трех вкладках: **«Типовые настройки»**, **«Список параметров устройства»** и **«Подключение к ТС ПИоТ»**. Под вкладками, независимо от выбранной, отображается [текущий статус устройства](#текущий-статус-устройства).
...
Поле под вкладками карточки, в котором отображается состояние оборудования на текущий момент. Оно видно на всех вкладках и не зависит от того, какая из них открыта. Статус меняется командами меню **«Оборудование»** (см. [ниже](#меню-оборудование)) и при инициализации оборудования.
...
Кнопка **«Настроить параметры»** открывает окно настроек экземпляра оборудования. Клик по полю параметра в колонке **«Значение»** активирует его для редактирования — в примере ниже открыто для правки поле наименований видов платежей:
