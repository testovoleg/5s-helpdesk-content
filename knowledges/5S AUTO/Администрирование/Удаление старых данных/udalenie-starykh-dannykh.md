...
| Цены | Информация об установленных ценах | Рекомендуется не трогать* |
| Скидки | Информация об установленных скидках | Рекомендуется не трогать* |
...
| Сделки, Лиды | Удалять не рекомендуется — по ним должна оставаться статистика |
| Остальные (Общие, Контроль неликвидов) | Можно удалять |
