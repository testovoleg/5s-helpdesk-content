...
- **Электронное письмо** и **Событие (Пять систем)** — занимают больше всего места среди документов.
- **Событие** — практически не используется, можно оставить за 1–3 месяца.
- **РН Продажи** и **РН Выработка сотрудников** — после удаления данные не будут отражаться в отчетах: лучше не удалять, но если занимают много места — можно почистить.
